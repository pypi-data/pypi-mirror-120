...
class FuncButtonGroup():
    def __init__(self, p=None):
        self.list_button = list()
        self.id_current_btn = 0
        self.num_btn = 0
        self.id_btn = 0
    ...
    def addButton(self, btn):
        self.id_btn += 1
        self.num_btn += 1
        btn.setWhatsThis(str(self.id_btn))
        self.list_button.append(btn)

    def addButtons(self, list_btn: list):
        for btn in list_btn:
            self.addButton(btn)
...
class FuncButton(QPushButton):
    def __init__(self, group: FuncButtonGroup, ico=None, text='', p=None):
    ...
    def group_effect(self):
        if self.group.id_current_btn:
            self.group.list_button[self.group.id_current_btn - 1].uncheck()
        self.group.id_current_btn = int(self.whatsThis())
        self.group.list_button[self.group.id_current_btn - 1].check()
