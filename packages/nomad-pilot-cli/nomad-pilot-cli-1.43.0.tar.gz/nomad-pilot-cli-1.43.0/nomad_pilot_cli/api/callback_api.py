...
class CallbackApi(object):
    ...
    def haiku_callback(self, store, haiku, **kwargs):  # noqa: E501
        """haiku  # noqa: E501

        The order confirmation of logistics haiku  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.haiku_callback(store, haiku, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str store: ID of the store. (required)
        :param Haiku haiku: Haiku confirmation body (required)
        ...
        :return: ApiResponseHaiku
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.haiku_callback_with_http_info(store, haiku, **kwargs)  # noqa: E501

    def haiku_callback_with_http_info(self, store, haiku, **kwargs):  # noqa: E501
        """haiku  # noqa: E501

        The order confirmation of logistics haiku  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.haiku_callback_with_http_info(store, haiku, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ApiResponseHaiku, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['store', 'haiku']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('store' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `store` when calling `haiku_callback`")  # noqa: E501
        # verify the required parameter 'haiku' is set
        if self.api_client.client_side_validation and ('haiku' not in local_var_params or  # noqa: E501
                                                        local_var_params['haiku'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `haiku` when calling `haiku_callback`")  # noqa: E501
        ...
        body_params = None
        if 'haiku' in local_var_params:
            body_params = local_var_params['haiku']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='ApiResponseHaiku',  # noqa: E501
