...
from nomad_pilot_cli.models.api_response_haiku import ApiResponseHaiku  # noqa: E501
from nomad_pilot_cli.rest import ApiException

class TestApiResponseHaiku(unittest.TestCase):
    """ApiResponseHaiku unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ApiResponseHaiku
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = nomad_pilot_cli.models.api_response_haiku.ApiResponseHaiku()  # noqa: E501
        if include_optional :
