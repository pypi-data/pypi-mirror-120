...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.20.0-alpha.1631718486+6cc29eec'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.20.0-alpha.1631718486+6cc29eec`
                """)
            else:
                raise
