...
class DataConnection(BaseDataConnection):
    ...
    def read_indices(self, indices_location: str = None, **kwargs):
        ...
        if indices_location is not None:    # when location is provided from metadata
            holdout_data_indices_location = indices_location
        ...
        if with_holdout_split:
            try:
                indices = self.read_indices(
                    indices_location=experiment_metadata.get('holdout_data_indices_location'))
