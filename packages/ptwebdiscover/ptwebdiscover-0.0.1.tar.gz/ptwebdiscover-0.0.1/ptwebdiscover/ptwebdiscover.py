...
class ptwebdiscover():
    def __init__(self, args):
        ...
        self.args.charset           = ptmisclib.get_charset(args.charsets)
    ...
    def prepare_backup(self):
        self.backup_exts       = [".bak", ".old", ".zal", ".zip", ".rar", ".tar", ".tar.gz"]
        self.backup_all_exts   = [".zip", ".rar", ".tar", ".tar.gz", ".sql", ".sql.gz"]
        self.delimeters        = ["", "_", ".", "-"]
...
def parse_args():
    ...
    parser.add_argument("-ch", "--charsets", type=str, nargs="+", default=["lowercase"])
