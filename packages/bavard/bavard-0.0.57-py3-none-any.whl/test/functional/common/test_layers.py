...
class TestLayers(TestCase):
    ...
    def _test_body(self, body: ModelBody, is_sequence_problem: bool):
        ...
        acc = model.evaluate(X, y, verbose=0, return_dict=True)["sparse_categorical_accuracy"]
        ...
        loaded_acc = loaded_model.evaluate(X, y, verbose=0, return_dict=True)["sparse_categorical_accuracy"]
