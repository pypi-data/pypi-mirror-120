...
class EmailSerializers(serializers.ModelSerializer):
    ...
    """ serializer of EmailModel Table with regex """
...
class EmailReminderSerializer(serializers.ModelSerializer):
    ...
    """ serializer of email reminder table """
    ...
    def to_representation(self, instance):
        """ representation for displaying fields name insted of ForeignKey id in Table  """
...
class ModuleSerializer(serializers.ModelSerializer):
    """ serializer of Module Table ( listing of all created tables in model) """
    class Meta:
        model = Modules
        fields = '__all__'
...
class UserEmailSerializer(serializers.ModelSerializer):
    """ serializer for user creation table"""
    class Meta:
        model = UserEmails
        fields = ['user', 'email']
