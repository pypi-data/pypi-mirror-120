...
class BaseDBHelper(object):
    ...
    def get_simple_list(self, table_name, fields, conditions=None, raw_conditions='', order_field='id', order_type='DESC'):
        return self.get_list(table_name, fields, conditions=conditions, raw_conditions=raw_conditions, order_field=order_field, order_type=order_type, pagination=False)

    def get_list(self, table_name, fields, conditions=None, raw_conditions='', order_field='id', order_type='DESC', page_index=0, page_size=10, pagination=True):
        params = []
        condition = ''
        rst = None
        cnt = 0
