"""Utility methods for blocktorch objectives."""
from .objective_base import ObjectiveBase

from blocktorch import objectives
from blocktorch.exceptions import ObjectiveCreationError, ObjectiveNotFoundError
from blocktorch.problem_types import handle_problem_types
from blocktorch.utils.gen_utils import _get_subclasses
...
def _all_objectives_dict():
    ...
    for objective in all_objectives:
        if "blocktorch.objectives" not in objective.__module__:
            continue
...
def get_objective(objective, return_instance=False, **kwargs):
    ...
    if objective.lower() not in all_objectives_dict:
        raise ObjectiveNotFoundError(
            ...
            "Use blocktorch.objectives.get_all_objective_names()"
