...
from blocktorch.exceptions import PipelineScoreError
...
@patch("blocktorch.pipelines.ClassificationPipeline._decode_targets", return_value=[0, 1])
@patch(
    "blocktorch.objectives.BinaryClassificationObjective.decision_function",
...
@patch("blocktorch.pipelines.ComponentGraph._compute_features")
...
@patch("blocktorch.pipelines.BinaryClassificationPipeline.score")
@patch("blocktorch.pipelines.BinaryClassificationPipeline.predict_proba")
