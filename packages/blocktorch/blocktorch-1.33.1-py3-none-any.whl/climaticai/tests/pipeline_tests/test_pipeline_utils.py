        ...
        X_all = pd.DataFrame(
            {
                ...
                * 2,
                "email": [
                    ...
                    "fooEMAIL@email.org",
                    "blocktorch@blocktorch.org",
                    "blocktorch@alteryx.org",
                ]
                * 2,
                "url": [
...
def test_generate_code_pipeline_json_with_objects():
    ...
    assert (
        ...
        == "from blocktorch.pipelines.binary_classification_pipeline import BinaryClassificationPipeline\n"
...
def test_generate_code_pipeline():
    ...
    expected_code = (
        "from blocktorch.pipelines.regression_pipeline import RegressionPipeline\n"
