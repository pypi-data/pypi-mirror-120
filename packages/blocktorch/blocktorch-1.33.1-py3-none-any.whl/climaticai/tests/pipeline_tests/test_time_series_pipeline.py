...
from blocktorch.exceptions import PipelineNotYetFittedError
from blocktorch.objectives import FraudCost, get_objective
from blocktorch.pipelines import (
    TimeSeriesBinaryClassificationPipeline,
    TimeSeriesMulticlassClassificationPipeline,
    TimeSeriesRegressionPipeline,
)
from blocktorch.pipelines.components import DelayedFeatureTransformer, Transformer
from blocktorch.pipelines.utils import _get_pipeline_base_class
from blocktorch.preprocessing.utils import is_classification
...
@patch("blocktorch.pipelines.components.RandomForestRegressor.fit")
@patch("blocktorch.pipelines.components.RandomForestClassifier.fit")
@patch(
    "blocktorch.pipelines.TimeSeriesClassificationPipeline._encode_targets",
...
@patch("blocktorch.pipelines.components.RandomForestClassifier.predict")
@patch("blocktorch.pipelines.components.RandomForestRegressor.predict")
...
@patch("blocktorch.pipelines.components.RandomForestRegressor.fit")
@patch("blocktorch.pipelines.components.RandomForestRegressor.predict")
@patch("blocktorch.pipelines.components.LogisticRegressionClassifier.fit")
@patch("blocktorch.pipelines.components.LogisticRegressionClassifier.predict")
@patch(
    "blocktorch.pipelines.TimeSeriesClassificationPipeline._encode_targets",
    side_effect=lambda y: y,
)
@patch(
    "blocktorch.pipelines.TimeSeriesClassificationPipeline._decode_targets",
    side_effect=lambda y: y,
)
@patch("blocktorch.pipelines.PipelineBase._score_all_objectives")
@patch("blocktorch.pipelines.TimeSeriesBinaryClassificationPipeline._score_all_objectives")
def test_score(
    mock_binary_score,
    mock_score,
    mock_encode_targets,
...
@patch("blocktorch.pipelines.LogisticRegressionClassifier.fit")
@patch("blocktorch.pipelines.LogisticRegressionClassifier.predict_proba")
@patch("blocktorch.pipelines.LogisticRegressionClassifier.predict")
@patch("blocktorch.pipelines.TimeSeriesClassificationPipeline._score_all_objectives")
@patch("blocktorch.pipelines.ClassificationPipeline._decode_targets")
@patch("blocktorch.pipelines.ClassificationPipeline._encode_targets")
...
@patch("blocktorch.pipelines.TimeSeriesClassificationPipeline._decode_targets")
@patch("blocktorch.objectives.BinaryClassificationObjective.decision_function")
@patch("blocktorch.pipelines.components.Estimator.predict_proba")
@patch(
    "blocktorch.pipelines.components.Estimator.predict",
...
def test_time_series_pipeline_not_fitted_error(
    ...
    if is_classification(problem_type):
        to_patch = "blocktorch.pipelines.TimeSeriesClassificationPipeline.predict_in_sample"
        if problem_type == ProblemTypes.TIME_SERIES_BINARY:
            to_patch = "blocktorch.pipelines.TimeSeriesBinaryClassificationPipeline.predict_in_sample"
...
@patch("blocktorch.objectives.FraudCost.decision_function")
...
@patch("blocktorch.pipelines.LogisticRegressionClassifier.fit")
@patch("blocktorch.pipelines.components.ElasticNetRegressor.fit")
...
@patch("blocktorch.pipelines.components.Imputer.transform")
@patch("blocktorch.pipelines.components.OneHotEncoder.transform")
@pytest.mark.parametrize(
    "problem_type",
    [
        ProblemTypes.TIME_SERIES_BINARY,
