...
from blocktorch.pipelines import BinaryClassificationPipeline, RegressionPipeline
...
from blocktorch.pipelines.components.ensemble import (
    SklearnStackedEnsembleClassifier,
    SklearnStackedEnsembleRegressor,
)
from blocktorch.pipelines.components.transformers.preprocessing.log_transformer import (
    LogTransformer,
)
from blocktorch.pipelines.components.transformers.samplers.base_sampler import (
    BaseSampler,
)
...
def test_generate_code():
    expected_code = (
        "from blocktorch.pipelines.components.estimators.classifiers.logistic_regression_classifier import LogisticRegressionClassifier"
    ...
    expected_code = (
        "from blocktorch.pipelines.components.estimators.regressors.et_regressor import ExtraTreesRegressor"
    ...
    expected_code = (
        "from blocktorch.pipelines.components.transformers.imputers.imputer import Imputer"
