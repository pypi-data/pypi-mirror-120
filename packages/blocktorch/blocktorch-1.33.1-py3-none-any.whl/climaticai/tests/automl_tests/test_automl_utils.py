...
from blocktorch.objectives import F1, R2, LogLossBinary, LogLossMulticlass
from blocktorch.pipelines import (
    BinaryClassificationPipeline,
    MulticlassClassificationPipeline,
    RegressionPipeline,
)
from blocktorch.preprocessing.data_splitters import (
    TimeSeriesSplit,
...
@patch(
    "blocktorch.pipelines.BinaryClassificationPipeline._encode_targets",
