...
from blocktorch.exceptions import ComponentNotYetFittedError
from blocktorch.pipelines.components import TargetEncoder
...
@patch("blocktorch.pipelines.components.transformers.transformer.Transformer.fit")
