...
from blocktorch.pipelines import BinaryClassificationPipeline, ComponentGraph
...
@patch("blocktorch.pipelines.pipeline_base.jupyter_check")
@patch("blocktorch.pipelines.pipeline_base.import_or_raise")
