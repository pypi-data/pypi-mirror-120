...
from blocktorch.model_family.model_family import ModelFamily
from blocktorch.model_understanding.prediction_explanations._algorithms import (
...
from blocktorch.pipelines.components.utils import _all_estimators_used_in_search
from blocktorch.pipelines.utils import make_pipeline
from blocktorch.problem_types.problem_types import ProblemTypes
...
@patch(
    "blocktorch.model_understanding.prediction_explanations._algorithms.shap.TreeExplainer"
)
...
@patch("blocktorch.model_understanding.prediction_explanations._algorithms.logger")
