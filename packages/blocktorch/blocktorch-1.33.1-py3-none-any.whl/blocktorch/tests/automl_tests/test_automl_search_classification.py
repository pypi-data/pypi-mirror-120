...
from blocktorch.automl.automl_algorithm import DefaultAlgorithm, IterativeAlgorithm
from blocktorch.automl.callbacks import raise_error_callback
from blocktorch.automl.pipeline_search_plots import SearchIterationPlot
from blocktorch.automl.utils import get_best_sampler_for_data
from blocktorch.exceptions import ParameterNotUsedWarning, PipelineNotFoundError
...
from blocktorch.pipelines.components.utils import get_estimators
from blocktorch.pipelines.utils import make_pipeline
from blocktorch.preprocessing import TimeSeriesSplit, split_data
...
@patch("blocktorch.pipelines.components.estimators.Estimator.fit")
@patch(
    "blocktorch.pipelines.BinaryClassificationPipeline.score",
    return_value={"Log Loss Binary": 0.5},
)
@patch(
    "blocktorch.pipelines.MulticlassClassificationPipeline.score",
