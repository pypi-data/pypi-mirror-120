...
from blocktorch.automl import AutoMLSearch, search
from blocktorch.automl.automl_algorithm import DefaultAlgorithm
from blocktorch.utils import infer_feature_types


@patch("blocktorch.data_checks.default_data_checks.DefaultDataChecks.validate")
@patch("blocktorch.automl.AutoMLSearch.search")
