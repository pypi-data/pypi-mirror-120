...
from blocktorch.pipelines.component_graph import ComponentGraph
...
@patch("blocktorch.pipelines.RegressionPipeline.predict")
...
@patch("blocktorch.pipelines.ComponentGraph.fit")
@patch("blocktorch.pipelines.RegressionPipeline.predict")
...
@patch("blocktorch.pipelines.BinaryClassificationPipeline._encode_targets")
@patch("blocktorch.pipelines.BinaryClassificationPipeline.fit")
@patch("blocktorch.pipelines.components.Estimator.predict")
...
@patch("blocktorch.pipelines.MulticlassClassificationPipeline._encode_targets")
...
@patch("blocktorch.pipelines.MulticlassClassificationPipeline._encode_targets")
@patch("blocktorch.pipelines.MulticlassClassificationPipeline.fit")
@patch("blocktorch.pipelines.ComponentGraph.predict")
...
@patch("blocktorch.objectives.R2.score")
@patch("blocktorch.pipelines.RegressionPipeline.fit")
@patch("blocktorch.pipelines.RegressionPipeline.predict")
...
@patch("blocktorch.pipelines.BinaryClassificationPipeline._encode_targets")
@patch("blocktorch.objectives.F1.score")
@patch("blocktorch.pipelines.BinaryClassificationPipeline.fit")
@patch("blocktorch.pipelines.components.Estimator.predict")
...
@patch("blocktorch.pipelines.MulticlassClassificationPipeline._encode_targets")
@patch("blocktorch.objectives.F1Micro.score")
@patch("blocktorch.pipelines.MulticlassClassificationPipeline.fit")
@patch("blocktorch.pipelines.components.Estimator.predict")
...
@patch("blocktorch.pipelines.components.StandardScaler.transform")
...
@patch("blocktorch.pipelines.components.Imputer.transform")
@patch("blocktorch.pipelines.components.OneHotEncoder.transform")
@patch("blocktorch.pipelines.components.RandomForestClassifier.predict_proba")
@patch("blocktorch.pipelines.components.ElasticNetClassifier.predict_proba")
@patch("blocktorch.pipelines.components.RandomForestClassifier.predict")
@patch("blocktorch.pipelines.components.ElasticNetClassifier.predict")
...
def test_pipeline_not_fitted_error(
    ...
    if is_classification(problem_type):
        to_patch = "blocktorch.pipelines.ClassificationPipeline._predict"
        if problem_type == ProblemTypes.BINARY:
            to_patch = "blocktorch.pipelines.BinaryClassificationPipeline._predict"
...
@patch("blocktorch.pipelines.PipelineBase.fit")
@pytest.mark.parametrize(
    "problem_type",
    [ProblemTypes.BINARY, ProblemTypes.MULTICLASS, ProblemTypes.REGRESSION],
)
def test_nonlinear_pipeline_not_fitted_error(
    ...
    clf.fit(X, y)
    if problem_type in [ProblemTypes.BINARY, ProblemTypes.MULTICLASS]:
        with patch("blocktorch.pipelines.ClassificationPipeline.predict") as mock_predict:
            clf.predict(X)
            mock_predict.assert_called()
        with patch(
            "blocktorch.pipelines.ClassificationPipeline.predict_proba"
        ) as mock_predict_proba:
            clf.predict_proba(X)
            mock_predict_proba.assert_called()
    else:
        with patch("blocktorch.pipelines.RegressionPipeline.predict") as mock_predict:
            clf.predict(X)
            mock_predict.assert_called()
    clf.feature_importance
