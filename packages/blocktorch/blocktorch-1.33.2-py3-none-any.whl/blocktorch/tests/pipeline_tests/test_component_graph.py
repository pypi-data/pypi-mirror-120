...
from blocktorch.pipelines import ComponentGraph
...
from blocktorch.pipelines.components.transformers.transformer import (
    TargetTransformer,
)
...
@patch("blocktorch.pipelines.components.Transformer.fit_transform")
...
@patch("blocktorch.pipelines.components.TargetImputer.fit_transform")
@patch("blocktorch.pipelines.components.OneHotEncoder.fit_transform")
...
@patch("blocktorch.pipelines.components.Imputer.fit_transform")
...
@patch("blocktorch.pipelines.components.estimators.LogisticRegressionClassifier.fit")
...
@patch("blocktorch.pipelines.components.Imputer.transform")
@patch("blocktorch.pipelines.components.OneHotEncoder.transform")
@patch("blocktorch.pipelines.components.TargetImputer.transform")
