...
from blocktorch.automl.automl_algorithm import (
...
from blocktorch.pipelines.components import Estimator
...
@patch(
    "blocktorch.pipelines.components.ensemble.SklearnStackedEnsembleClassifier._stacking_estimator_class"
)
