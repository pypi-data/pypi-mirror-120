...
from blocktorch.automl.automl_algorithm import IterativeAlgorithm
from blocktorch.automl.automl_search import build_engine_from_str
from blocktorch.automl.callbacks import (
    log_error_callback,
    raise_error_callback,
    silent_error_callback,
)
from blocktorch.automl.engine import CFEngine, DaskEngine, SequentialEngine
from blocktorch.automl.utils import (
    _LARGE_DATA_PERCENT_VALIDATION,
    _LARGE_DATA_ROW_THRESHOLD,
    get_default_primary_search_objective,
    get_pipelines_from_component_graphs,
)
from blocktorch.exceptions import (
...
from blocktorch.objectives import (
    F1,
...
from blocktorch.objectives.utils import (
...
from blocktorch.pipelines.components.utils import (
    allowed_model_families,
    get_estimators,
)
from blocktorch.pipelines.utils import make_pipeline
from blocktorch.preprocessing import TrainingValidationSplit
...
from blocktorch.tests.automl_tests.parallel_tests.test_automl_dask import (
    engine_strs,
)
from blocktorch.tests.conftest import CustomClassificationObjectiveRanges
from blocktorch.tuners import NoParamsException, RandomSearchTuner, SKOptTuner
...
@patch("blocktorch.objectives.AUC.score")
...
@patch("blocktorch.tuners.random_search_tuner.RandomSearchTuner.is_search_space_exhausted")
...
@patch("blocktorch.automl.automl_algorithm.IterativeAlgorithm.next_batch")
...
@patch("blocktorch.automl.automl_algorithm.IterativeAlgorithm.__init__")
...
@patch("blocktorch.automl.automl_search.AutoMLSearch.search")
...
@patch("blocktorch.automl.engine.sequential_engine.SequentialComputation.get_result")
...
@patch("builtins.input")
@patch("blocktorch.automl.engine.sequential_engine.SequentialComputation.done")
...
@patch(
    "blocktorch.automl.engine.sequential_engine.SequentialComputation.done",
    side_effect=KeyboardInterruptOnKthPipeline(k=4, starting_index=2),
)
@patch("blocktorch.automl.engine.sequential_engine.SequentialComputation.cancel")
...
@patch("blocktorch.automl.automl_algorithm.IterativeAlgorithm.next_batch")
@patch("blocktorch.automl.AutoMLSearch.full_rankings", new_callable=PropertyMock)
@patch("blocktorch.automl.AutoMLSearch.rankings", new_callable=PropertyMock)
...
@patch("blocktorch.automl.engine.engine_base.split_data")
...
@patch("blocktorch.tuners.skopt_tuner.Optimizer.tell")
def test_percent_better_than_baseline_in_rankings(
    ...
    baseline_pipeline_class = {
        ProblemTypes.BINARY: "blocktorch.pipelines.BinaryClassificationPipeline",
        ProblemTypes.MULTICLASS: "blocktorch.pipelines.MulticlassClassificationPipeline",
        ProblemTypes.REGRESSION: "blocktorch.pipelines.RegressionPipeline",
        ProblemTypes.TIME_SERIES_REGRESSION: "blocktorch.pipelines.TimeSeriesRegressionPipeline",
    }[problem_type_value]
...
@patch("blocktorch.pipelines.BinaryClassificationPipeline.fit")
@patch("blocktorch.pipelines.MulticlassClassificationPipeline.fit")
@patch("blocktorch.pipelines.RegressionPipeline.fit")
@patch("blocktorch.pipelines.TimeSeriesRegressionPipeline.fit")
@patch("blocktorch.tuners.skopt_tuner.Optimizer.tell")
...
@patch("blocktorch.tuners.skopt_tuner.SKOptTuner.add")
...
@patch("blocktorch.objectives.BinaryClassificationObjective.optimize_threshold")
...
@patch("blocktorch.automl.engine.sequential_engine.train_pipeline")
...
def test_automl_issues_beta_warning_for_time_series(problem_type, X_y_binary):
    ...
    with warnings.catch_warnings(record=True) as warn:
        ...
        assert len(warn) == 1
        message = "Time series support in blocktorch is still in beta, which means we are still actively building its core features"
...
@pytest.mark.parametrize("verbose", [True, False])
@patch(
    "blocktorch.objectives.binary_classification_objective.BinaryClassificationObjective.optimize_threshold",
    return_value=0.65,
)
...
@patch("blocktorch.objectives.standard_metrics.F1.optimize_threshold", return_value=0.42)
...
@patch(
    "blocktorch.data_checks.target_distribution_data_check.TargetDistributionDataCheck.validate"
)
...
@patch("blocktorch.pipelines.components.Estimator.fit")
@patch(
    "blocktorch.pipelines.BinaryClassificationPipeline.score",
