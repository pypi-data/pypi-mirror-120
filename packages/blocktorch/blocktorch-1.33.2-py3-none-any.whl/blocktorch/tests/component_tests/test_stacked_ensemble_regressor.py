...
from blocktorch.exceptions import EnsembleMissingPipelinesError
...
@patch(
    "blocktorch.pipelines.components.ensemble.SklearnStackedEnsembleRegressor._stacking_estimator_class"
)
...
@patch("blocktorch.pipelines.components.ensemble.SklearnStackedEnsembleRegressor.fit")
