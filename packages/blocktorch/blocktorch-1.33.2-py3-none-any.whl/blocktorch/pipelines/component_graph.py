...
from blocktorch.exceptions.exceptions import (
    MethodPropertyNotFoundError,
    MissingComponentError,
    ParameterNotUsedWarning,
)
from blocktorch.pipelines.components import ComponentBase, Estimator, Transformer
from blocktorch.pipelines.components.transformers.transformer import (
    TargetTransformer,
)
from blocktorch.pipelines.components.utils import handle_component_class
from blocktorch.utils import import_or_raise, infer_feature_types
from blocktorch.utils.logger import get_logger
    ...
    def __repr__(self):
        ...
        for (
            ...
            try:
                ...
                # Not an blocktorch component, use component class name
