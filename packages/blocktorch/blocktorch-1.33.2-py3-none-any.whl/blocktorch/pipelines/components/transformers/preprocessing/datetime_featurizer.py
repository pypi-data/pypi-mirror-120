...
class RealDateTimeFeaturizer(Transformer):
    """Transformer that can automatically extract features from datetime columns.
    ...
    name = "Real DateTime Featurization Component"
...
def func(X):
    dtf = RealDateTimeFeaturizer()
    return dtf.fit_transform(X)
...
class DateTimeFeaturizer(Transformer):
    ...
    def transform(self, X, y=None):
        ...
        return xformer.fit_transform(X)
