...
from blocktorch.pipelines.components import ARIMARegressor
...
@patch(
    "blocktorch.pipelines.components.estimators.regressors.arima_regressor.ARIMARegressor._format_dates"
)
@patch(
    "blocktorch.pipelines.components.estimators.regressors.arima_regressor.ARIMARegressor._get_dates"
)
