"""Utility methods for blocktorch pipelines."""
import logging
...
from blocktorch.data_checks import DataCheckActionCode, TargetDistributionDataCheck
from blocktorch.model_family import ModelFamily
from blocktorch.pipelines.components import (  # noqa: F401
    CatBoostClassifier,
    CatBoostRegressor,
    ComponentBase,
    DateTimeFeaturizer,
...
def generate_pipeline_code(element):
    """Creates and returns a string that contains the Python imports and code required for running the blocktorch pipeline.
