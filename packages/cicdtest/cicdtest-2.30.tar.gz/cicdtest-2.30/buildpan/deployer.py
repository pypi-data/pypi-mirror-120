...
def mean_stack(cwd):
    ...
    result_install = subprocess.run("npm install", shell = True, stdout= subprocess.PIPE, stderr = subprocess.STDOUT)
...
def script_runer(scripts, cwd):
    ...
    for script in scripts:
        result = subprocess.run(script,shell= True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, cwd = cwd)
