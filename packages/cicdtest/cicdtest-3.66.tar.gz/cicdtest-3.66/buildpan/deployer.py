...
def mean_stack(cwd, project_id, repo_name, username):
    ...
    try:
        ...
        if result_install.returncode:
            requests.post(fetch_log + "?" +'project_id='+project_id+'&repo_name='+repo_name+'&Time='+str(curtime)+'&user_name='+username+'&message=deployment = '+str(result_install.stdout.decode())+'&status=npm installed')
            return success 
        else:
            ...
            if result_install_pm2.returncode:
                requests.post(fetch_log + "?" +'project_id='+project_id+'&repo_name='+repo_name+'&Time='+str(curtime)+'&user_name='+username+'&message=deployment = '+str(result_install.stdout.decode())+'&status=pm2 installed/updated')
                return success
            else:
                ...
                if service_status.stdout.decode().find("online") == -1:
                    ...
                    requests.post(fetch_log + "?" +'project_id='+project_id+'&repo_name='+repo_name+'&Time='+str(curtime)+'&user_name='+username+'&message=deployment = '+str(result_install.stdout.decode())+'&status=pm2 started')
                else:
                    ...
                    requests.post(fetch_log + "?" +'project_id='+project_id+'&repo_name='+repo_name+'&Time='+str(curtime)+'&user_name='+username+'&message=deployment = '+str(result_install.stdout.decode())+'&status=pm2 reloaded')
        ...
        requests.post(fetch_log + "?" +'project_id='+project_id+'&repo_name='+repo_name+'&Time='+str(curtime)+'&user_name='+username+'&message=Exception: deployment = '+str(e)+'&status=deployment process failed')
