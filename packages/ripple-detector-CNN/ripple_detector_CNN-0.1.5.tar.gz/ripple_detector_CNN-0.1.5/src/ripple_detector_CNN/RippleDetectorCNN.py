#!/usr/bin/env python3
# Time-stamp: "2021-09-20 22:48:59 (ywatanabe)"
...
class RippleDetectorCNN(object):
    ...
    def estimate_ripple_proba(self, batch_size=32, checkpoint=None):
        ...
        self._load_the_trained_CNN(checkpoint=checkpoint)
    ...
    def _load_the_trained_CNN(self, checkpoint=None):
        ## Model initialization
        ResNet1D_conf = next(
            yaml.load_all(
                pkgutil.get_data("ripple_detector_CNN", "data/ResNet1D.yaml"),
        ...
        if checkpoint is not None:
            ...
            print("\ncheckpoint file was not loaded. Thus, the weights are random.\n")
