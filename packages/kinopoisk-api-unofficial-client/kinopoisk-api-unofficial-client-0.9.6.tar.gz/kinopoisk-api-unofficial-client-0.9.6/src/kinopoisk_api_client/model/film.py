...
from kinopoisk_api_client.model.dictonary.film_type import FilmType
from kinopoisk_api_client.model.dictonary.production_status import ProductionStatus
from kinopoisk_api_client.model.genre import Genre
