...
from src.synthetic_sample import calculation_utils, generate_synthetic_curves, generate_synthetic_records, sample_curve

module_path = Path(__file__).parent


def synthetic_sample(input_dict: dict, output_directory: str, create_records_dataset: bool = False) -> dict:
    ...
    with open(f"synthetic_sample/src/synthetic_sample/defaults/lib/standard.json", "r") as f:
