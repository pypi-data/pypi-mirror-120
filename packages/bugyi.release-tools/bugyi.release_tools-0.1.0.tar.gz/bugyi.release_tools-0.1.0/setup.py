...
DESCRIPTION = "Scripts that help release new versions of software."
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "bugyi.release_tools = bugyi.release_tools.cli:main",
        ]
    },
    ...
    name="bugyi.release_tools",
    package_dir={"": "src"},
    packages=find_namespace_packages(where="src"),
    test_suite="tests",
    tests_require=tests_require(),
    url="https://github.com/bbugyi200/python-release-tools",
