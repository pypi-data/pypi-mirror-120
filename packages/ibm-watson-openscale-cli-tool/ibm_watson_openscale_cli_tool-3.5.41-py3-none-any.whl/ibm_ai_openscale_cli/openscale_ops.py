...
# coding=utf-8
import time
from ibm_ai_openscale_cli.enums import ResetType, MLEngineType, Environment
...
class OpenScaleOps(Ops):
    ...
    def __init__(self, args):
        ...
        if fairness_version.startswith("1"):
            self._args.env = Environment.PUBLIC_CLOUD.value
        elif fairness_version.startswith("3"):
            self._args.env = Environment.CPD_3_X.value
        elif fairness_version.startswith("4.0.0"):
            self._args.env = Environment.CPD_4_0_0.value
        elif fairness_version.startswith("4.0.1"):
            self._args.env = Environment.CPD_4_0_1.value
        elif fairness_version.startswith("4.0.2"):
            self._args.env = Environment.CPD_4_0_2_PLUS.value
        else:
            self._args.env = Environment.CPD_4_0_2_PLUS.value
