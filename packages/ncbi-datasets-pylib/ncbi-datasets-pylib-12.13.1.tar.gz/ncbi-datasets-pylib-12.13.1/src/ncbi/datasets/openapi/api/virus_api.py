...
class VirusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.sars2_protein_download = _Endpoint(
            settings={
            ...
            callable=__sars2_protein_download
        )

        def __sars2_protein_summary(
            self,
            proteins,
            **kwargs
        ):
        ...
        self.sars2_protein_summary = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__sars2_protein_summary
        )

        def __sars2_protein_table(
            self,
            proteins,
            **kwargs
        ):
        ...
        self.sars2_protein_table = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__sars2_protein_table
        )

        def __virus_genome_download(
            self,
            taxon,
            **kwargs
        ):
        ...
        self.virus_genome_download = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__virus_genome_download
        )

        def __virus_genome_summary(
            self,
            taxon,
            **kwargs
        ):
        ...
        self.virus_genome_summary = _Endpoint(
            settings={
                'response_type': (V1DownloadSummary,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__virus_genome_summary
        )

        def __virus_genome_table(
            self,
            taxon,
            **kwargs
        ):
        ...
        self.virus_genome_table = _Endpoint(
            settings={
                'response_type': (V1TabularOutput,),
                'auth': [
                    'ApiKeyAuthHeader'
