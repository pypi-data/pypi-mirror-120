...
class GenomeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __assembly_descriptors_by_accessions(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.assembly_descriptors_by_accessions = _Endpoint(
            settings={
            ...
            callable=__assembly_descriptors_by_accessions
        )

        def __assembly_descriptors_by_bioproject(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.assembly_descriptors_by_bioproject = _Endpoint(
            settings={
                'response_type': (V1AssemblyMetadata,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__assembly_descriptors_by_bioproject
        )

        def __assembly_descriptors_by_taxon(
            self,
            taxon,
            **kwargs
        ):
        ...
        self.assembly_descriptors_by_taxon = _Endpoint(
            settings={
                'response_type': (V1AssemblyMetadata,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__assembly_descriptors_by_taxon
        )

        def __check_assembly_availability(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.check_assembly_availability = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__check_assembly_availability
        )

        def __check_assembly_availability_post(
            self,
        ...
        self.check_assembly_availability_post = _Endpoint(
            settings={
                'response_type': (V1AssemblyDatasetAvailability,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__check_assembly_availability_post
        )

        def __download_assembly_package(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.download_assembly_package = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__download_assembly_package
        )

        def __download_assembly_package_post(
            self,
            v1_assembly_dataset_request,
            **kwargs
        ):
        ...
        self.download_assembly_package_post = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__download_assembly_package_post
        )

        def __genome_download_summary(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.genome_download_summary = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__genome_download_summary
        )

        def __genome_download_summary_by_post(
            self,
            v1_assembly_dataset_request,
            **kwargs
        ):
        ...
        self.genome_download_summary_by_post = _Endpoint(
            settings={
                'response_type': (V1DownloadSummary,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__genome_download_summary_by_post
        )

        def __genome_metadata_by_post(
            self,
        ...
        self.genome_metadata_by_post = _Endpoint(
            settings={
                'response_type': (V1AssemblyMetadata,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__genome_metadata_by_post
        )

        def __genome_tax_name_query(
            self,
            taxon_query,
            **kwargs
        ):
        ...
        self.genome_tax_name_query = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__genome_tax_name_query
        )

        def __genome_tax_tree(
            self,
            taxon,
            **kwargs
        ):
        ...
        self.genome_tax_tree = _Endpoint(
            settings={
