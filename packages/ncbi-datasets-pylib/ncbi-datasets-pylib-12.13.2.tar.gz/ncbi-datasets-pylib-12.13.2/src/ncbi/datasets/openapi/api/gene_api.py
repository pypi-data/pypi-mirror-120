...
class GeneApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.download_gene_package = _Endpoint(
            settings={
            ...
            callable=__download_gene_package
        )

        def __download_gene_package_post(
            self,
        ...
        self.download_gene_package_post = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__download_gene_package_post
        )

        def __gene_download_summary_by_accession(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.gene_download_summary_by_accession = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__gene_download_summary_by_accession
        )

        def __gene_download_summary_by_id(
            self,
            gene_ids,
            **kwargs
        ):
        ...
        self.gene_download_summary_by_id = _Endpoint(
            settings={
                'response_type': (V1DownloadSummary,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__gene_download_summary_by_id
        )

        def __gene_download_summary_by_post(
            self,
            v1_gene_dataset_request,
            **kwargs
        ):
        ...
        self.gene_download_summary_by_post = _Endpoint(
            settings={
                'response_type': (V1DownloadSummary,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__gene_download_summary_by_post
        )

        def __gene_download_summary_by_tax_and_symbol(
            self,
            symbols,
            taxon,
            **kwargs
        ...
        self.gene_download_summary_by_tax_and_symbol = _Endpoint(
            settings={
                'response_type': (V1DownloadSummary,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__gene_download_summary_by_tax_and_symbol
        )

        def __gene_metadata_by_accession(
            self,
            accessions,
            **kwargs
        ):
        ...
        self.gene_metadata_by_accession = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__gene_metadata_by_accession
        )

        def __gene_metadata_by_id(
            self,
            gene_ids,
            **kwargs
        ):
        ...
        self.gene_metadata_by_id = _Endpoint(
            settings={
                'response_type': (V1GeneMetadata,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__gene_metadata_by_id
        )

        def __gene_metadata_by_post(
            self,
            v1_gene_dataset_request,
            **kwargs
        ):
        ...
        self.gene_metadata_by_post = _Endpoint(
            settings={
                'response_type': (V1GeneMetadata,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__gene_metadata_by_post
        )

        def __gene_metadata_by_tax_and_symbol(
            self,
            symbols,
            taxon,
            **kwargs
        ...
        self.gene_metadata_by_tax_and_symbol = _Endpoint(
            settings={
                'response_type': (V1GeneMetadata,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__gene_metadata_by_tax_and_symbol
        )

        def __gene_metadata_stream_by_post(
            self,
            v1_gene_dataset_request,
            **kwargs
        ):
        ...
        self.gene_metadata_stream_by_post = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__gene_metadata_stream_by_post
        )

        def __gene_orthologs_by_id(
            self,
            gene_id,
            **kwargs
        ):
        ...
        self.gene_orthologs_by_id = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__gene_orthologs_by_id
        )

        def __gene_tax_name_query(
            self,
            taxon_query,
            **kwargs
        ):
        ...
        self.gene_tax_name_query = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__gene_tax_name_query
        )
