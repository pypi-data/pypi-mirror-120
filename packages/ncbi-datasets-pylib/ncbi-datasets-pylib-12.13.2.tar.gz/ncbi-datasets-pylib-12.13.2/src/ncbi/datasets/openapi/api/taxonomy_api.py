...
class TaxonomyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.tax_name_query = _Endpoint(
            ...
            callable=__tax_name_query
        )

        def __taxonomy_filtered_subtree(
            self,
            taxons,
            **kwargs
        ):
        ...
        self.taxonomy_filtered_subtree = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__taxonomy_filtered_subtree
        )

        def __taxonomy_filtered_subtree_post(
            self,
        ...
        self.taxonomy_filtered_subtree_post = _Endpoint(
            settings={
                'response_type': (V1TaxonomyFilteredSubtreeResponse,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__taxonomy_filtered_subtree_post
        )

        def __taxonomy_metadata(
            self,
            taxons,
            **kwargs
        ):
        ...
        self.taxonomy_metadata = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__taxonomy_metadata
        )

        def __taxonomy_metadata_post(
            self,
        ...
        self.taxonomy_metadata_post = _Endpoint(
            settings={
                'response_type': (V1TaxonomyMetadataResponse,),
                'auth': [
                    'ApiKeyAuthHeader'
            ...
            api_client=api_client,
            callable=__taxonomy_metadata_post
        )
