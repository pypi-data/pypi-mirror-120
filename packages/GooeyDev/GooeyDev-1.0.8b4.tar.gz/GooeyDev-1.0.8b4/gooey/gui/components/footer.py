...
class Footer(wx.Panel):
    ...
    def _init_components(self):
        self.cancel_button = self.button(_('cancel'), wx.ID_OK, event_id=events.WINDOW_CANCEL)
        ...
        self.submit_button = self.button(_("Submit"), wx.ID_OK, event_id=int(events.WINDOW_SUBMIT))
        self.progress_bar = wx.Gauge(self, range=100)

        self.time_remaining_text = wx.StaticText(self)

        self.buttons = [self.cancel_button, self.start_button, self.print_cmd_button, self.submit_button,
    ...
    def _do_layout(self):
        ...
        h_sizer.Add(self.submit_button, 0, wx.RIGHT, 20)
