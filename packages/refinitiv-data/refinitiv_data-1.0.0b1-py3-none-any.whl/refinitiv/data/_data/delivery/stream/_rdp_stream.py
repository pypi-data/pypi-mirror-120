...
class _RDPStream(Stream):
    ...
    def _get_subscription_request_message(self):
        ...
        #   override with extended_params is needed
    ...
    async def _subscribe_async(self):
        ...
        self._session.log(
            5,
            "_RDPStream.subscribe_async() - waiting for subscribe name = {}".format(
                self._name
            ),
        )
        ...
        self._session.log(
            5, "open message = {}".format(get_subscription_request_message)
        )
