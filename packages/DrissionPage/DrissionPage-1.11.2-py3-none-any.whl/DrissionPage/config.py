...
class OptionsManager(object):
    ...
    def __init__(self, path: str = None):
        ...
        """
        self.ini_path = r'.\configs.ini' if path == 'default' or path is None else path
        ...
        if 'tmp_path' not in self.paths or not self.get_value('paths', 'tmp_path'):
            tmp_path = Path(r'.\tmp').absolute()
            tmp_path.mkdir(parents=True, exist_ok=True)
            self.set_item('paths', 'tmp_path', str(tmp_path))
    ...
    def save(self, path: str = None):
        ...
        """
        if path == 'default':
            path = Path(r'.\configs.ini').absolute()
        elif path is None:
...
class SessionOptions(object):
    def __init__(self, read_file: bool = True, ini_path: str = None):
        ...
        if read_file:
            self.ini_path = ini_path or r'.\configs.ini'
    ...
    def save(self, path: str = None):
        ...
        if path.exists():
            ...
            om = OptionsManager(self.ini_path or r'.\configs.ini')
