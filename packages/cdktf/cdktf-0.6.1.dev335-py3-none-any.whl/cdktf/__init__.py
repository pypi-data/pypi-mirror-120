...
class Fn(metaclass=jsii.JSIIMeta, jsii_type="cdktf.Fn"):
    ...
    def replace(
        ...
        '''(experimental) {@link https://www.terraform.io/docs/language/functions/split.html replace} searches a given string for another given substring, and replaces each occurrence with a given replacement string.
