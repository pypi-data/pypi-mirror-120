...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        successful_trials = [i for i in self.data if i > 0]
        list_size = len(self.data)
        prob = len(successful_trials)/list_size
        self.p = prob
        self.n = list_size
        self.calculate_mean()
    ...
    def plot_bar(self):
        ...
        xaxis_data = [0,1]
        failures = [i for i in self.data   if i == 0]
        num_success = [i for i in self.data if i > 0]
        yaxis_data = [len(failures),len(num_success)]

        fig, ax = plt.subplots()
        
        ax.set_xlabel('size {}'.format(len(self.data)))
        ax.set_title('Binomial distribution ')
        ax.bar(xaxis_data, yaxis_data)
        plt.show()
    ...
    def pdf(self, k):
        ...
        pdf = math.comb(self.n, k) * math.pow(self.p,k) * math.pow((1-self.p),(self.n - k))
    ...
    def plot_bar_pdf(self):
        ...
        ax.set_title('Probability density function of Binomial distribution ')
    ...
    def __add__(self, other):
        ...
        print('first {}, second {}'.format(self.n, other.n))
