...
class Seti():
    ...
    def read_wallet_data(self,secret:str):
        ...
        return ResponseCreateTransaction(self.send_request(data_read_wallet,encode_data,READ_WALLET_URL))
    ...
    def read_wallet_transactions(self,secret:str):
        ...
        return ResponseCreateTransaction(self.send_request(data_read_wallet_transactions,encode_data,READ_WALLET_TRANSACTIONS_URL))
