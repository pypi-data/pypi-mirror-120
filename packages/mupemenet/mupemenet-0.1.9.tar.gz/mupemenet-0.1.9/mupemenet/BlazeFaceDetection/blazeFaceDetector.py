...
from BlazeFaceDetection.blazeFaceUtils import gen_anchors, SsdAnchorsCalculatorOptions, nms
...
class blazeFaceDetector():
	...
	def initializeModel(self, type):
		if type == "front":
			self.interpreter = Interpreter(model_path=MODELS_PATH+"/face_detection_front.tflite", num_threads=4)
		elif type =="back":
			self.interpreter = Interpreter(model_path=MODELS_PATH+"/face_detection_back.tflite", num_threads=4)
