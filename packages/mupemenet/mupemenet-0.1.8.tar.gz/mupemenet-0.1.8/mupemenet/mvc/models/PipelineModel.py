...
from facerecognitionpipeline.RecognitionElf import RecognitionElf
from facerecognitionpipeline.DetectionElf import DetectionElf

from mvc.models.Model import Model
from mvc.utils.Utils import MAX_TOF_RANGE, MIN_BB_IMAGE_RATIO, MIN_TOF_RANGE, is_exit_signal, measure, no_user
...
class RpiRanger(OsRanger):
    def __init__(self) -> None:
        import VL53L0X_rasp_python.python.VL53L0X as VL
        self.tof = VL.VL53L0X()
