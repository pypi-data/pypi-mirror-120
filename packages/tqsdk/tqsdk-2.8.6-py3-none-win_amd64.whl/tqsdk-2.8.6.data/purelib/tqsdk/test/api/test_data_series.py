...
from tqsdk import TqApi, utils, TqChan
...
class TestDataSeries(TQBaseTestcase):
    ...
    def test_get_data_series1(self):
        ...
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series1.script.lzma"))
    ...
    def test_get_data_series2(self):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series2.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
        # 测试
        utils.RD = random.Random(4)
    ...
    def test_get_data_series3(self):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series3.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
        # 测试
        utils.RD = random.Random(4)
    ...
    def test_get_data_series4(self):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series4.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
        # 测试
        utils.RD = random.Random(4)
    ...
    def test_get_data_series5(self):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series5.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
        # 测试
        utils.RD = random.Random(4)
    ...
    def test_get_data_series6(self):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series6.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
        # 测试
        utils.RD = random.Random(4)
    ...
    def test_get_data_series7(self):
        dir_path = os.path.dirname(os.path.realpath(__file__))
        self.md_mock.run(os.path.join(dir_path, "get_data_series_files", "test_get_data_series7.script.lzma"))
        md_url = f"ws://127.0.0.1:{self.md_mock.port}/"
        # 测试
        utils.RD = random.Random(4)
