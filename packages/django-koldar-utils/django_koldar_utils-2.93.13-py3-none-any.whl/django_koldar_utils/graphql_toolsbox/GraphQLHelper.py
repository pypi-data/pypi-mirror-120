...
from django_koldar_utils.django_toolbox import filters_helpers, django_helpers, permissions_helpers, auth_decorators
...
class GraphQLHelper(object):
    ...
    def generate_query_from_queryset_filter(cls,
        ...
        :param query_class_name: name of the type to generate. This does not repersent the name of the query!
        :param description: description of the query to generate
        :param output_name: name of the output field generated by this query. **This repersents the name of the query**
        ...
        def body(mutation_class, info, *args, **kwargs) -> any:
            ...
            if return_type == "single":
                ...
                raise ValueError(f"Invalid multipler f{return_multipler}!")
        ...
        return result, {output_name: getattr(result, output_name)}
