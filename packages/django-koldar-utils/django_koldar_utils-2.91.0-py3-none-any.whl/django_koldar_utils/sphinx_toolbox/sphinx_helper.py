...
class AbstractSphinxConfigurator(abc.ABC):
    ...
    up project. We assume that the CWD is the source directory, which a sibling of the directory containing the
    python package you have just developed. Another sibling of the "source" directory is "setup.py", setuptools
    installer.
    """
    ...
    def fetch_project_information(self) -> Dict[str, any]:
        ...
        but the following are required:
         ...
         - project_package_name: name of the package in the parent directory of "source" specifying the python
            pacakge project
    ...
    def configure(self, module_name: str) -> Dict[str, any]:
        ...
        # the script is executed in the "source" directory of sphinx.
...
class DjangoLibrarySphinxConfigurator(AbstractSphinxConfigurator):
    ...
    def configure_sphinx_extension(self, extension_name: str):
        ...
        if extension_name == 'sphinx.ext.viewcode':
            self.sphinx_script.html_show_sourcelink = False  # Remove 'view source code' from top of page (for html, not python)
