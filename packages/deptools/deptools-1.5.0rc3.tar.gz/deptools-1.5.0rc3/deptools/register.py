...
Usage:
  register [--dev] [--dry-run] [-p <password>] <specfile> <base_url> <version>
  register -h | --help
  register --version

Options:
  -h --help      Show this screen
  -p <password>  If a password should be registered with the website, you can
                 give it here.
...
def register(development, password, specsfile, baseurl, version, dry_run):
