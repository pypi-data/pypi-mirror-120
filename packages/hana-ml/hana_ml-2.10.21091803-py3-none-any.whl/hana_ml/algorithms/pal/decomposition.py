...
class _PCABase(PALBase):
    ...
    def _fit(self, data, key=None, features=None, label=None,#pylint:disable=too-many-statements
        ...
        if self.allow_cat is True:
            ...
            param_rows_new = [
                ...
                ('RANDOM_STATE', self.random_state, None, None),
    ...
    def _fit_transform(self, data, key=None, features=None, n_components=None, label=None):#pylint:disable=invalid-name
        ...
        if self.scores_ is None:
            return self._transform(data_, key, features, n_components, label)
        if label is None:
            return self.scores_
        return self.scores_.alias('L').join(data_.alias('R'), 'L.%s' % key + '= R.%s' % key, select=['L.*', label])

    def _transform(self, data, key=None, features=None, n_components=None, label=None):#pylint:disable=invalid-name, too-many-locals
        conn = data.connection_context
        require_pal_usable(conn)
...
class _CATPCA(_PCABase):
    ...
    n_components : int
        Specifies the number of components to extract.
    ...
    max_iter : int, optional
        Specifies the maximum number of interations allowed in computing the
    ...
    def __init__(self,
                 ...
                 svd_alg=None,
                 lanczos_iter=None):
        super(_CATPCA, self).__init__(scaling=scaling,
                                      thread_ratio=thread_ratio,
                                      scores=scores,
                                      allow_cat=True,
                                      n_components=n_components,
    ...
    def fit(self, data, key=None, features=None, categorical_variable=None):
        ...
        """
        return super(_CATPCA, self)._fit(data=data, key=key,
                                         features=features,
                                         label=None,
                                         categorical_variable=categorical_variable)

    def fit_transform(self, data, key=None, features=None, n_components=None):
        r"""
        Fit with the dataset and return the scores.
        ...
        """
        return super(_CATPCA, self)._fit_transform(data=data, key=key,
                                                   features=features,
                                                   n_components=n_components,
                                                   label=None)

    def transform(self, data, key=None, features=None, n_components=None):
        r"""
        Principal component analysis projection function using a trained model.
        ...
        DataFrame
            ...
            structured as follows:
                ...
                - 3rd column, type DOUBLE, named 'COMPONENT_SCORE', representing the
                  score values of each data points in different components.
        """
        return super(_CATPCA, self)._transform(data=data, key=key,
                                               features=features,
                                               n_components=n_components,
                                               label=None)
