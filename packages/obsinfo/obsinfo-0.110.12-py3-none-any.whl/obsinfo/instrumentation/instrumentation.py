...
class Instrumentation(object):
    ...
    Attributes:
        operator (:class:`Operator`): Will be converted into Station.Equipment
        equipment :class:`Equipment`): Will be converted into Station.Equipment
    ...
    def __init__(self, attributes_dict_or_list, locations,
        ...
        Args:
            attributes_dict_or_list (dict/ObsMetadata or list of
                dicts/ObsMetadata): instrumentation(s) attributes
