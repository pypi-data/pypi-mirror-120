...
from hbshare.rm_associated.util.data_loader import CtaNavAttributionLoader
from hbshare.rm_associated.util.regressions import Regression
from hbshare.rm_associated.util.config import cta_factors
...
if __name__ == '__main__':
    ...
    res = CtaNavAttribution('SGU333', '20191227', '20210806').calculate()
