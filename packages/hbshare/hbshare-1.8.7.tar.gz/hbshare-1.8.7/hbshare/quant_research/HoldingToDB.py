...
if __name__ == '__main__':
    ...
    #                  table_name="private_fund_holding", fund_name="因诺聚配中证500指数增强", is_increment=1).writeToDB()
    # HoldingExtractor(data_path='D:\\估值表基地\\量客卓宇六号', table_name="private_fund_holding",
    #                  fund_name="量客卓宇六号", is_increment=1).writeToDB()
    HoldingExtractor(data_path='D:\\估值表基地\\星阔广厦12号中证500指增', table_name="private_fund_holding",
                     fund_name="星阔广厦12号中证500指数增强", is_increment=1).writeToDB()
