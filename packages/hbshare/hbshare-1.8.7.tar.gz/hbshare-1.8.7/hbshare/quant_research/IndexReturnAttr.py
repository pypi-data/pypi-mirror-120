...
import pandas as pd
import datetime
from hbshare.rm_associated.util.config import industry_name
...
if __name__ == '__main__':
    ind_attr1 = IndexSectorReturnAttr('20201220', '20210917', '000300').get_construct_result()
    ind_attr2 = IndexSectorReturnAttr('20201220', '20210917', '000905').get_construct_result()
    ind_attr3 = IndexSectorReturnAttr('20201220', '20210917', '000852').get_construct_result()
