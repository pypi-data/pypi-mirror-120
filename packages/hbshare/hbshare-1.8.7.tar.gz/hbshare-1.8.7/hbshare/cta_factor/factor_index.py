...
from hbshare.cta_factor.factor_algo import (
    carry, tsmom, tsrev, xsmom, xsrev, tswr, xswr, mr, mrchg, tsmr, tsbasismom, xsbasismom
)
...
def run():
    ...
    factor_compute(
        ...
        liq_days=liq_d, data_raw=data_contracts
    )

    factor_compute(
        window_days_list=window_days_list[:10], data=data, factor_func=tsbasismom, liq_days=liq_d, data_raw=data_contracts
    )
