...
class JsonImports:
    official_country_names = json.loads(open(r"json\dicts\official_country_names.json").read())
    iso3_to_capital = json.loads(open(r"json/dicts/iso3_to_capital.json").read())
