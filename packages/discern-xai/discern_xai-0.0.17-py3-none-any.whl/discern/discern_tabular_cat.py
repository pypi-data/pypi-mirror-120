...
class DisCERNTabularCat(DisCERN):
    """
    ...
    def _find_cf(self, test_instance, test_label, desired_class='opposite', **kwargs):
        """
        ...
        nun_data, nun_label = util.nun(self.norm_train_data, self.train_labels, norm_test_instance, test_label, len(self.norm_train_data))
    ...
    def _show_cf(self, test_instance, test_label, cf, cf_label, **kwargs):
        None