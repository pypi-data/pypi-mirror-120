...
class ResponseExperimentInfo(object):
    ...
    def __init__(self, cli_driven_project=None, created_by=None, created_dt=None, endpoints=None, env_vars=None, exit_code=None, experiment_plot_volume=None, experiment_plot_volume_id=None, histories=None, id=None, kernel_cluster=None, kernel_cluster_node=None, kernel_cluster_select_policies=None, kernel_image=None, kernel_resource_spec=None, message=None, metrics_summary=None, name=None, number=None, organization=None, project=None, reproduce_command=None, source_code_link=None, start_command=None, status=None, status_last_updated=None, status_reason=None, sweep=None, termination_protection=None, version_control_project=None, volume_mounts=None, local_vars_configuration=None):  # noqa: E501
