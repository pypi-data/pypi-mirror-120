...
class ResponseDashboardResponse(object):
    ...
    openapi_types = {
        ...
        'grouped_fields': 'list[ResponseDashboardExperimentFieldResponse]',
    ...
    def __init__(self, filters=None, grouped_fields=None, sorts=None, local_vars_configuration=None):  # noqa: E501
    ...
    def grouped_fields(self):
        """Gets the grouped_fields of this ResponseDashboardResponse.  # noqa: E501


        :return: The grouped_fields of this ResponseDashboardResponse.  # noqa: E501
        :rtype: list[ResponseDashboardExperimentFieldResponse]
        """
        return self._grouped_fields

    @grouped_fields.setter
    def grouped_fields(self, grouped_fields):
        """Sets the grouped_fields of this ResponseDashboardResponse.


        :param grouped_fields: The grouped_fields of this ResponseDashboardResponse.  # noqa: E501
        :type grouped_fields: list[ResponseDashboardExperimentFieldResponse]
        """
        if self.local_vars_configuration.client_side_validation and grouped_fields is None:  # noqa: E501
            raise ValueError("Invalid value for `grouped_fields`, must not be `None`")  # noqa: E501
