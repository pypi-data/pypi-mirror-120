    ...
    def sign(mobile, password):
        ...
        try:
            ...
            if response.get("code") == 0:
                ...
                return token, {"name": "登录账号", "value": mobile}
            else:
                return False, {"name": "登录账号", "value": "登录失败"}
    ...
    def checkin(token):
        ...
        try:
            ...
            if response.get('code') == 0:
                ...
                if checkin_result:
                    return {"name": "签到状态", "value": "签到成功"}
                else:
                    return {"name": "签到状态", "value": "已签到过或签到失败"}
            else:
                return {"name": "签到状态", "value": "签到失败"}
        except Exception as e:
            return {"name": "签到状态", "value": "签到失败"}
