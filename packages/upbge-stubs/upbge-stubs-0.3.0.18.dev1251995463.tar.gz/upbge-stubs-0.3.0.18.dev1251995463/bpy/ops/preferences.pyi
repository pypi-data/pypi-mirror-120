...
def studiolight_install(files: typing.Union[typing.Sequence[OperatorFileListElement], typing.Mapping[str, OperatorFileListElement]] = None, directory: str = '', filter_folder: bool = True, filter_glob: str = '*.png;*.jpg;*.hdr;*.exr', type: str = 'MATCAP') -> None:
