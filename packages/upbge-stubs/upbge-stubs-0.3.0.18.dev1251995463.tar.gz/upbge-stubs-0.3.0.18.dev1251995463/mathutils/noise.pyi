...
def turbulence_vector(position: mathutils.Vector, octaves: int, hard: typing.Any, noise_basis: str = 'PERLIN_ORIGINAL', amplitude_scale: float = 0.5, frequency_scale: float = 2.0) -> mathutils.Vector:
