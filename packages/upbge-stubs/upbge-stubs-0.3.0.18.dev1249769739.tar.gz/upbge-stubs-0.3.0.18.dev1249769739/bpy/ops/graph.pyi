...
def select_lasso(path: typing.Union[typing.Sequence[OperatorMousePath], typing.Mapping[str, OperatorMousePath]] = None, mode: str = 'SET', use_curve_selection: bool = True) -> None:
