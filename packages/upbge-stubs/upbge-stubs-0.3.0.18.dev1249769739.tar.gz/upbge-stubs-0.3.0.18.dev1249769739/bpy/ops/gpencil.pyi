...
def annotate(mode: str = 'DRAW', arrowstyle_start: str = 'NONE', arrowstyle_end: str = 'NONE', use_stabilizer: bool = False, stabilizer_factor: float = 0.75, stabilizer_radius: int = 35, stroke: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement]] = None, wait_for_input: bool = True) -> None:
...
def draw(mode: str = 'DRAW', stroke: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement]] = None, wait_for_input: bool = True, disable_straight: bool = False, disable_fill: bool = False, disable_stabilizer: bool = False, guide_last_angle: float = 0.0) -> None:
...
def sculpt_paint(stroke: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement]] = None, wait_for_input: bool = True) -> None:
...
def select_lasso(mode: str = 'SET', path: typing.Union[typing.Sequence[OperatorMousePath], typing.Mapping[str, OperatorMousePath]] = None) -> None:
...
def stroke_cutter(path: typing.Union[typing.Sequence[OperatorMousePath], typing.Mapping[str, OperatorMousePath]] = None, flat_caps: bool = False) -> None:
...
def vertex_paint(stroke: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement]] = None, wait_for_input: bool = True) -> None:
...
def weight_paint(stroke: typing.Union[typing.Sequence[OperatorStrokeElement], typing.Mapping[str, OperatorStrokeElement]] = None, wait_for_input: bool = True) -> None:
