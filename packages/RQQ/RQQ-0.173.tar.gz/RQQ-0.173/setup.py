    ...
    class PostCMD(install):
          ...
          def  run(self):
                ...
                def  cleanup_function( **dictOP ):
                    ...
                    print("@runB id(siteOP): ",id(siteOP))
                ...
                ######################################
                atexit.register(cleanup_function,  sitePATH= siteOP()+os.path.sep+Var.nameA  , siteOP= site  , name= name , package= Var.nameA )
