  ...
  if sys.argv[1]== 'bdist_wheel' or sys.argv[1]== 'sdist' or  sys.argv[1]=='install' or sys.argv[1]=="egg_info" or sys.argv[1]=='clean':
    ...
    class PostCMD(install):
          ...
          def  run(self):
                ...
                ####################### 路徑  物件  專案名
                def  cleanup_function(sitePATH,siteOP,name):
                    ...
                    if os.name=='nt':
                        ...
                        print("@專案是否存在..",os.path.isdir( sitePATH+os.path.sep+name ) ,sitePATH+os.path.sep+name )
                ...
                print("@_name_:::",name)
                atexit.register(cleanup_function,  siteOP()+os.path.sep+Var.nameA  ,site  , name )
