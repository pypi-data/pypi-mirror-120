  ...
  if sys.argv[1]== 'bdist_wheel' or sys.argv[1]== 'sdist' or  sys.argv[1]=='install' or sys.argv[1]=="egg_info" or sys.argv[1]=='clean':
    ...
    class PostCMD(install):
          ...
          def  run(self):
                ...
                def  cleanup_function(nameOP,siteOP):
                    # print("@siteOP 123:",siteOP)
                    

                    import os
                    import importlib as L
                    cmds   = L.import_module( Var.nameA[0:-3] )
                    ...
                    # import os
                    # os.system("echo xxx>/content/OP.py")
                    ...
                    # import os
                    # # os.system(f"rm -rf {siteOP()+os.path.sep+__name__}")
                    # SS=f"rm -rf {siteOP()+os.path.sep+__name__}"
                    # os.system(f"echo '{SS}'>/content/OP.py")
                    
                    import os
                    # print("@_main_site_@:",id(site))
                    os.system(f"echo {id(siteOP)} > /content/siteID.py")
                    os.system(f"echo {nameOP} > /content/nameID.py")
                    
                    # rm -rf /usr/local/lib/python3.7/dist-packages/__main__
                ...
                print("@_main_site_@:",id(site))
                ### 名稱在: 上面函數設定
                atexit.register(cleanup_function,  siteOP()+os.path.sep+Var.nameA  ,site)
