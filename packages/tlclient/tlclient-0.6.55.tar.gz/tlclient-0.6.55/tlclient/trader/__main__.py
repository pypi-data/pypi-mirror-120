...
Arguments:
    ...
    3. EXCHANGE: [sse, sze, hk, ssc, sec, cffex, dce, shfe, czce, cme, cme_cbt]
Examples:
...
Arguments:
    1. EXCHANGE: [sse, sze, hk, ssc, sec, cffex, dce, shfe, czce, cme, cme_cbt]
Examples:
...
valid_exchange =        {'sse': ExchangeID.SSE, 'sze': ExchangeID.SZE, 'hk': ExchangeID.HK, 'ssc': ExchangeID.SSC, 'sec': ExchangeID.SEC,
                         ...
                         'ine': ExchangeID.INE, 'czce': ExchangeID.CZCE, 'cme': ExchangeID.CME, 'cme_cbt': ExchangeID.CME_CBT}
...
The supported commands are:
    insert          insert order. Return value: order id
        ...
        -e              exchange (SSE/SZE/HK/SSC/SEC/CFFEX/DCE/SHFE/CZCE), e.g. SZE
