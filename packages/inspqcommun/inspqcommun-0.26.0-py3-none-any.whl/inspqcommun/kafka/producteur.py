...
def obtenirConfigurationsProducteurDepuisVariablesEnvironnement():
    ...
    if 'KAFKA_SSL_TRUSTSTORE_LOCATION' in os.environ:
        config_kafka['ssl.truststore.location'] = os.environ['KAFKA_SSL_TRUSTSTORE_LOCATION']
    if 'KAFKA_SSL_TRUSTSTORE_PASSWORD' in os.environ:
        config_kafka['ssl.truststore.password'] = os.environ['KAFKA_SSL_TRUSTSTORE_PASSWORD']
    if 'KAFKA_SSL_KEYSTORE_LOCATION' in os.environ:
        config_kafka['ssl.keystore.location'] = os.environ['KAFKA_SSL_KEYSTORE_LOCATION']
    if 'KAFKA_SSL_KEYSTORE_PASSWORD' in os.environ:
        config_kafka['ssl.keystore.password'] = os.environ['KAFKA_SSL_KEYSTORE_PASSWORD']
