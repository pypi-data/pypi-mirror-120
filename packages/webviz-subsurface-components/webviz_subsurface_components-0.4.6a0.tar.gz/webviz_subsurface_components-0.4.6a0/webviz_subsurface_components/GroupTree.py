...
- edge_options (list of dicts; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, data=Component.UNDEFINED, edge_options=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'data', 'edge_options']
        self._type = 'GroupTree'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'data', 'edge_options']
