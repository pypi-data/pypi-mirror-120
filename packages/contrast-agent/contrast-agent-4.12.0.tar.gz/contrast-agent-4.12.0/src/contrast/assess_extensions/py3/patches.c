...
static PyMethodDef methods[] = {
    ...
    {"create_thread_storage", create_thread_storage, METH_O, "Create thread storage with initial scope and context"},
    {"destroy_thread_storage", destroy_thread_storage, METH_NOARGS, "Teardown storage for thread"},
    {"set_thread_context", set_thread_context, METH_O, "Set request context for thread"},
    {"get_thread_context", get_thread_context, METH_NOARGS, "Get request context for thread"},
