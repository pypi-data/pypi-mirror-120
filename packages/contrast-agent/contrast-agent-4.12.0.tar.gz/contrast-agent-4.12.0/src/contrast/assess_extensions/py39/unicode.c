...
HOOK_BINARYFUNC(unicode_partition, "partition");
...
HOOK_BINARYFUNC(unicode_rpartition, "rpartition");
...
static PyMethodDef methods[] = {
    {"apply_encode_hook", apply_unicode_encode_hook, METH_O, "Enable unicode.encode hook"},
    {"apply_replace_hook", apply_unicode_replace_hook, METH_O, "Enable unicode.replace hook"},
    {"apply_split_hook", apply_unicode_split_hook, METH_O, "Enable unicode.split hook"},
    {"apply_rsplit_hook", apply_unicode_rsplit_hook, METH_O, "Enable unicode.rsplit hook"},
    {"apply_join_hook", apply_unicode_join_hook, METH_O, "Enable unicode.join hook"},
    {"apply_capitalize_hook", apply_unicode_capitalize_hook, METH_O, "Enable unicode.capitalize hook"},
    {"apply_casefold_hook", apply_unicode_casefold_hook, METH_O, "Enable unicode.casefold hook"},
    {"apply_title_hook", apply_unicode_title_hook, METH_O, "Enable unicode.title hook"},
    {"apply_center_hook", apply_unicode_center_hook, METH_O, "Enable unicode.center hook"},
    {"apply_expandtabs_hook", apply_unicode_expandtabs_hook, METH_O, "Enable unicode.expandtabs hook"},
    {"apply_partition_hook", apply_unicode_partition_hook, METH_O, "Enable unicode.partition hook"},
    ...
    {"apply_lstrip_hook", apply_unicode_lstrip_hook, METH_O, "Enable unicode.lstrip hook"},
    {"apply_rjust_hook", apply_unicode_rjust_hook, METH_O, "Enable unicode.rjust hook"},
    {"apply_rstrip_hook", apply_unicode_rstrip_hook, METH_O, "Enable unicode.rstrip hook"},
    {"apply_rpartition_hook", apply_unicode_rpartition_hook, METH_O, "Enable unicode.rpartition hook"},
    {"apply_splitlines_hook", apply_unicode_splitlines_hook, METH_O, "Enable unicode.splitlines hook"},
    {"apply_strip_hook", apply_unicode_strip_hook, METH_O, "Enable unicode.strip hook"},
    {"apply_swapcase_hook", apply_unicode_swapcase_hook, METH_O, "Enable unicode.swapcase hook"},
    {"apply_translate_hook", apply_unicode_translate_hook, METH_O, "Enable unicode.translate hook"},
    ...
    {"apply_formatmap_hook", apply_unicode_formatmap_hook, METH_O, "Enable unicode.formatmap hook"},
    {"apply_removeprefix_hook", apply_unicode_removeprefix_hook, METH_O, "Enable unicode.removeprefix hook"},
    {"apply_removesuffix_hook", apply_unicode_removesuffix_hook, METH_O, "Enable unicode.removesuffix hook"},
    {NULL, NULL, 0, NULL},
};
