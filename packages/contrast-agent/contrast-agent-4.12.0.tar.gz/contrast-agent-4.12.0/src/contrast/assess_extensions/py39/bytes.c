...
static PyMethodDef methods[] = {
    ...
    {"apply_replace_hook", apply_bytes_replace_hook, METH_O, "Enable bytes.replace hook"},
    ...
    {"apply_capitalize_hook", apply_bytes_capitalize_hook, METH_O, "Enable bytes.capitalize hook"},
    ...
    {"apply_expandtabs_hook", apply_bytes_expandtabs_hook, METH_O, "Enable bytes.expandtabs hook"},
    {"apply_partition_hook", apply_bytes_partition_hook, METH_O, "Enable bytes.partition hook"},
    ...
    {"apply_rpartition_hook", apply_bytes_rpartition_hook, METH_O, "Enable bytes.rpartition hook"},
    {"apply_splitlines_hook", apply_bytes_splitlines_hook, METH_O, "Enable bytes.splitlines hook"},
    {"apply_strip_hook", apply_bytes_strip_hook, METH_O, "Enable bytes.strip hook"},
    {"apply_swapcase_hook", apply_bytes_swapcase_hook, METH_O, "Enable bytes.swapcase hook"},
    {"apply_translate_hook", apply_bytes_translate_hook, METH_O, "Enable bytes.translate hook"},
    ...
    {"apply_removeprefix_hook", apply_bytes_removeprefix_hook, METH_O, "Enable bytes.removeprefix hook"},
    {"apply_removesuffix_hook", apply_bytes_removesuffix_hook, METH_O, "Enable bytes.removesuffix hook"},
    {NULL, NULL, 0, NULL},
};
