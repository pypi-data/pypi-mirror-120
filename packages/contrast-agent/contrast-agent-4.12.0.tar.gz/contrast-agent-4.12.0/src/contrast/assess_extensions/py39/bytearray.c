...
static PyMethodDef methods[] = {
    {"apply_decode_hook", apply_bytearray_decode_hook, METH_O, "Enable bytearray.decode hook"},
    {"apply_replace_hook", apply_bytearray_replace_hook, METH_O, "Enable bytearray.replace hook"},
    {"apply_split_hook", apply_bytearray_split_hook, METH_O, "Enable bytearray.split hook"},
    {"apply_rsplit_hook", apply_bytearray_rsplit_hook, METH_O, "Enable bytearray.rsplit hook"},
    {"apply_join_hook", apply_bytearray_join_hook, METH_O, "Enable bytearray.join hook"},
    {"apply_capitalize_hook", apply_bytearray_capitalize_hook, METH_O, "Enable bytearray.capitalize hook"},
    {"apply_title_hook", apply_bytearray_title_hook, METH_O, "Enable bytearray.title hook"},
    {"apply_center_hook", apply_bytearray_center_hook, METH_O, "Enable bytearray.center hook"},
    {"apply_expandtabs_hook", apply_bytearray_expandtabs_hook, METH_O, "Enable bytearray.expandtabs hook"},
    {"apply_partition_hook", apply_bytearray_partition_hook, METH_O, "Enable bytearray.partition hook"},
    {"apply_ljust_hook", apply_bytearray_ljust_hook, METH_O, "Enable bytearray.ljust hook"},
    {"apply_lower_hook", apply_bytearray_lower_hook, METH_O, "Enable bytearray.lower hook"},
    {"apply_lstrip_hook", apply_bytearray_lstrip_hook, METH_O, "Enable bytearray.lstrip hook"},
    {"apply_rjust_hook", apply_bytearray_rjust_hook, METH_O, "Enable bytearray.rjust hook"},
    {"apply_rstrip_hook", apply_bytearray_rstrip_hook, METH_O, "Enable bytearray.rstrip hook"},
    {"apply_rpartition_hook", apply_bytearray_rpartition_hook, METH_O, "Enable bytearray.rpartition hook"},
    {"apply_splitlines_hook", apply_bytearray_splitlines_hook, METH_O, "Enable bytearray.splitlines hook"},
    {"apply_strip_hook", apply_bytearray_strip_hook, METH_O, "Enable bytearray.strip hook"},
    {"apply_swapcase_hook", apply_bytearray_swapcase_hook, METH_O, "Enable bytearray.swapcase hook"},
    {"apply_translate_hook", apply_bytearray_translate_hook, METH_O, "Enable bytearray.translate hook"},
    {"apply_upper_hook", apply_bytearray_upper_hook, METH_O, "Enable bytearray.upper hook"},
    {"apply_zfill_hook", apply_bytearray_zfill_hook, METH_O, "Enable bytearray.zfill hook"},
    {"apply_removeprefix_hook", apply_bytearray_removeprefix_hook, METH_O, "Enable bytearray.removeprefix hook"},
    {"apply_removesuffix_hook", apply_bytearray_removesuffix_hook, METH_O, "Enable bytearray.removesuffix hook"},
    {NULL, NULL, 0, NULL},
};
