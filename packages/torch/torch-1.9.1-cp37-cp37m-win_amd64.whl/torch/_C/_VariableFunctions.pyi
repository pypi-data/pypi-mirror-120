...
def _sparse_csr_tensor(crow_indices: Tensor, col_indices: Tensor, values: Tensor, size: Optional[_size]=None, *, dtype: Optional[_dtype]=None, device: Union[_device, str, None]=None, requires_grad:_bool=False) -> Tensor: ...
@overload
...
__all__ = ['__and__', '__lshift__', '__or__', '__rshift__', '__xor__', '_adaptive_avg_pool2d',
 ...
 '_choose_qparams_per_tensor', '_coalesce', '_compute_linear_combination', '_conj', '_convolution',
 ...
 '_mkldnn_reshape', '_mkldnn_transpose', '_mkldnn_transpose_', '_nnpack_available',
 ...
 '_sparse_addmm', '_sparse_coo_tensor_unsafe', '_sparse_csr_tensor', '_sparse_log_softmax',
 ...
 '_standard_gamma', '_standard_gamma_grad', '_test_serialization_subcmul', '_trilinear', '_unique',
 '_unique2', '_unpack_dual', '_use_cudnn_ctc_loss', '_use_cudnn_rnn_flatten_weight',
 '_validate_sparse_coo_tensor_args', '_weight_norm', '_weight_norm_cuda_interface', 'abs', 'abs_',
 'absolute', 'acos', 'acos_', 'acosh', 'acosh_', 'adaptive_avg_pool1d', 'adaptive_max_pool1d',
 'add', 'addbmm', 'addcdiv', 'addcmul', 'addmm', 'addmv', 'addmv_', 'addr', 'affine_grid_generator',
 'all', 'allclose', 'alpha_dropout', 'alpha_dropout_', 'amax', 'amin', 'angle', 'any', 'arange',
 'arccos', 'arccos_', 'arccosh', 'arccosh_', 'arcsin', 'arcsin_', 'arcsinh', 'arcsinh_', 'arctan',
 'arctan_', 'arctanh', 'arctanh_', 'argmax', 'argmin', 'argsort', 'as_strided', 'as_strided_',
 'as_tensor', 'asin', 'asin_', 'asinh', 'asinh_', 'atan', 'atan2', 'atan_', 'atanh', 'atanh_',
 ...
 'bitwise_not', 'bitwise_or', 'bitwise_xor', 'blackman_window', 'bmm', 'broadcast_to', 'bucketize',
 'can_cast', 'cat', 'ceil', 'ceil_', 'celu', 'celu_', 'channel_shuffle', 'cholesky',
 'cholesky_inverse', 'cholesky_solve', 'choose_qparams_optimized', 'chunk', 'clamp', 'clamp_',
 'clamp_max', 'clamp_max_', 'clamp_min', 'clamp_min_', 'clip', 'clip_', 'clone', 'column_stack',
 'combinations', 'complex', 'conj', 'constant_pad_nd', 'conv1d', 'conv2d', 'conv3d', 'conv_tbc',
 'conv_transpose1d', 'conv_transpose2d', 'conv_transpose3d', 'convolution', 'copysign', 'cos',
 'cos_', 'cosh', 'cosh_', 'cosine_embedding_loss', 'cosine_similarity', 'count_nonzero', 'cross',
 ...
 'exp2', 'exp2_', 'exp_', 'expm1', 'expm1_', 'eye', 'fake_quantize_per_channel_affine',
 ...
 'hardshrink', 'heaviside', 'hinge_embedding_loss', 'histc', 'hsmm', 'hsplit', 'hspmm', 'hstack',
 'hypot', 'i0', 'i0_', 'igamma', 'igammac', 'imag', 'index_add', 'index_copy', 'index_fill',
 'index_put', 'index_put_', 'index_select', 'init_num_threads', 'inner', 'instance_norm',
 'int_repr', 'inverse', 'is_complex', 'is_distributed', 'is_floating_point', 'is_grad_enabled',
 'is_inference_mode_enabled', 'is_nonzero', 'is_same_size', 'is_signed', 'is_vulkan_available',
 'isclose', 'isfinite', 'isinf', 'isnan', 'isneginf', 'isposinf', 'isreal', 'kaiser_window',
 'kl_div', 'kron', 'kthvalue', 'layer_norm', 'lcm', 'lcm_', 'ldexp', 'ldexp_', 'le', 'lerp', 'less',
 'less_equal', 'lgamma', 'linspace', 'log', 'log10', 'log10_', 'log1p', 'log1p_', 'log2', 'log2_',
 'log_', 'log_softmax', 'logaddexp', 'logaddexp2', 'logcumsumexp', 'logdet', 'logical_and',
 'logical_not', 'logical_or', 'logical_xor', 'logit', 'logit_', 'logspace', 'logsumexp', 'lstm',
 'lstm_cell', 'lstsq', 'lt', 'lu_solve', 'lu_unpack', 'margin_ranking_loss', 'masked_fill',
 ...
 'mkldnn_convolution_backward_weights', 'mkldnn_linear_backward_weights', 'mkldnn_max_pool2d',
 'mkldnn_max_pool3d', 'mm', 'mode', 'moveaxis', 'movedim', 'msort', 'mul', 'multinomial',
 'multiply', 'mv', 'mvlgamma', 'namedtuple_P_L_U', 'namedtuple_Q_R', 'namedtuple_U_S_V',
 'namedtuple_a_tau', 'namedtuple_eigenvalues_eigenvectors', 'namedtuple_mantissa_exponent',
 ...
 'pdist', 'permute', 'pinverse', 'pixel_shuffle', 'pixel_unshuffle', 'poisson', 'poisson_nll_loss',
 ...
 'repeat_interleave', 'reshape', 'resize_as_', 'resize_as_sparse_', 'result_type', 'rnn_relu',
 'rnn_relu_cell', 'rnn_tanh', 'rnn_tanh_cell', 'roll', 'rot90', 'round', 'round_', 'row_stack',
 'rrelu', 'rrelu_', 'rsqrt', 'rsqrt_', 'rsub', 'saddmm', 'scalar_tensor', 'scatter', 'scatter_add',
 'searchsorted', 'segment_reduce', 'select', 'selu', 'selu_', 'set_flush_denormal',
 ...
 'threshold', 'threshold_', 'tile', 'topk', 'trace', 'transpose', 'trapz', 'triangular_solve',
 'tril', 'tril_indices', 'triplet_margin_loss', 'triu', 'triu_indices', 'true_divide', 'trunc',
 'trunc_', 'unbind', 'unique_dim', 'unsafe_chunk', 'unsafe_split', 'unsafe_split_with_sizes',
 'unsqueeze', 'vander', 'var', 'var_mean', 'vdot', 'view_as_complex', 'view_as_real', 'vsplit',
 'vstack', 'where', 'xlogy', 'xlogy_', 'zero_', 'zeros', 'zeros_like']
