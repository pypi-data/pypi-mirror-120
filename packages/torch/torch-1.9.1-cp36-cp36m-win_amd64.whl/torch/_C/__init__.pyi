...
class _TensorBase(metaclass=_TensorMeta):
    ...
    def __ge__(self, other: Any) -> Tensor: ...  # type: ignore[override]
    def __getitem__(self, indices: Union[None, _int, slice, Tensor, List, Tuple]) -> Tensor: ...
    def __gt__(self, other: Any) -> Tensor: ...  # type: ignore[override]
    ...
    def __le__(self, other: Any) -> Tensor: ...  # type: ignore[override]
    ...
    def __lt__(self, other: Any) -> Tensor: ...  # type: ignore[override]
