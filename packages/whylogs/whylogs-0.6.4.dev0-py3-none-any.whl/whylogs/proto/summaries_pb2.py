...
_DATASETSUMMARYV2_COLUMNSENTRY = _descriptor.Descriptor(
  name='ColumnsEntry',
  full_name='DatasetSummaryV2.ColumnsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='DatasetSummaryV2.ColumnsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='DatasetSummaryV2.ColumnsEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATASETSUMMARYV2 = _descriptor.Descriptor(
  ...
  nested_types=[_DATASETSUMMARYV2_COLUMNSENTRY, _DATASETSUMMARYV2_METRICPLUGINSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_DATASETSUMMARYV2_COLUMNSENTRY.fields_by_name['value'].message_type = _COLUMNSUMMARY
_DATASETSUMMARYV2_COLUMNSENTRY.containing_type = _DATASETSUMMARYV2
...
_DATASETSUMMARYV2.fields_by_name['columns'].message_type = _DATASETSUMMARYV2_COLUMNSENTRY
...
DatasetSummaryV2 = _reflection.GeneratedProtocolMessageType('DatasetSummaryV2', (_message.Message,), dict(
  ...
  ColumnsEntry = _reflection.GeneratedProtocolMessageType('ColumnsEntry', (_message.Message,), dict(
    DESCRIPTOR = _DATASETSUMMARYV2_COLUMNSENTRY,
    __module__ = 'summaries_pb2'
    # @@protoc_insertion_point(class_scope:DatasetSummaryV2.ColumnsEntry)
    ))
  ,
...
_sym_db.RegisterMessage(DatasetSummaryV2.ColumnsEntry)
...
_DATASETSUMMARYV2_COLUMNSENTRY._options = None
