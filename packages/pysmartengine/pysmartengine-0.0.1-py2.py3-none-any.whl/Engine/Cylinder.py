...
class CylinderPressure:
    ...
    def plot(self, ValveTiming=None):
        if ValveTiming is None:
            from Valve.valve import ValveDesign
...
from Engine.GasProperty import Rg, k_Justi, cp_Justi, cv_Justi, u_Justi, h_Justi, m_fuel
...
class IdealCylcle:
    ...
    def compress(self, pim=2.5e5, Tim=300, Tr=800, xr=0.0, kc=1.3, phic=1):
        ...
        :return:
        """
        from Engine.GasProperty import DieselMixture, Rg
        self.kc = kc
    ...
    def pit(self, etaTK=0.56, pik=None):
        ...
        from Engine.GasProperty import k_exhaust_gu, k_Justi
        # 计算排气门打开时的压力和温度
    ...
    def analyze(self, speed=1500, plot=False):
        ...
        from Cylinder import thermalUsageIndex, exhaustTemperature
