...
class Cache:
    ...
    async def write_to_cache(self):
        ...
        for django_model, create_data in to_create_in_django.items():
            async_tasks.append(
            ...
            if len(async_tasks) == async_chunk_size or completed == to_complete:
                ...
                print(
                    f'{datetime.datetime.now()} - '
                    f'Created {completed} {self.django_model} instances from cache to django')
        ...
        for django_model, update_data in to_update_in_django.items():
            async_tasks.append(
            ...
            if len(async_tasks) == async_chunk_size or completed == to_complete:
                ...
                print(
                    f'{datetime.datetime.now()} - '
                    f'Updated {completed} {self.django_model} instances from cache to django')
