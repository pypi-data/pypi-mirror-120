    ...
    _onCommMsg(msg) {
        ...
        switch (event) {
            ...
            case 'binding_update':
                ...
                bindingIndex = (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_1__.findIndex)(tracker.bindings.iter(), ({ name }, _) => name === binding.name);
                if (bindingIndex > -1) {
...
class BindingStatusPanel extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Widget {
    /**
...
class BindingListWidget extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ReactWidget {
    ...
    render() {
        return react__WEBPACK_IMPORTED_MODULE_4__.createElement(BindingStatusList, { bindings: this._bindings });
    }
    dispose() {
        super.dispose();
        this._bindings = null;
...
class BindingStatusList extends react__WEBPACK_IMPORTED_MODULE_4__.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_4__.createElement("div", { className: "chi-BindingStatus" },
            react__WEBPACK_IMPORTED_MODULE_4__.createElement("div", { className: "chi-BindingStatus-header" }, "Active bindings"),
            this.state.bindings.map((binding) => {
                return react__WEBPACK_IMPORTED_MODULE_4__.createElement(BindingStatus, { binding: binding });
            })));
    }
...
function BindingStatus(props) {
    ...
    switch (props.binding.connection.type) {
        case 'local':
            hostDisplay = react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", null, "Local");
            break;
        case 'ssh':
            sshConnection = connection;
            hostDisplay = (react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", null,
                "Host: ",
                sshConnection.user && react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", null,
                    sshConnection.user,
                    "@"),
                react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", null, sshConnection.host)));
            break;
        case 'zun':
    ...
    const spinner = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Spinner();
    return (react__WEBPACK_IMPORTED_MODULE_4__.createElement("div", { className: "chi-Binding" },
        react__WEBPACK_IMPORTED_MODULE_4__.createElement("div", { className: "chi-Binding-name" }, props.binding.name),
        react__WEBPACK_IMPORTED_MODULE_4__.createElement("span", { className: `chi-BindingState-${props.binding.state}` },
            props.binding.state === 'creating' && spinner,
            props.binding.state),
        react__WEBPACK_IMPORTED_MODULE_4__.createElement("div", { className: "chi-BindingConnection" }, hostDisplay)));
}
...
//# sourceMappingURL=lib_index_js.d1f16dd6ce1572811a11.js.map