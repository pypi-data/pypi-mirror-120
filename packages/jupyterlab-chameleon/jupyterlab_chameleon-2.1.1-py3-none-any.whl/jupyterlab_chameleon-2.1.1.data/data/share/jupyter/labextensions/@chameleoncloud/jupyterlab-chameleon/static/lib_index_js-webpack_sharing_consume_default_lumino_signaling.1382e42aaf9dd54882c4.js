(self["webpackChunk_chameleoncloud_jupyterlab_chameleon"] = self["webpackChunk_chameleoncloud_jupyterlab_chameleon"] || []).push([["lib_index_js-webpack_sharing_consume_default_lumino_signaling"],{
...
class BindingRegistry {
    ...
    register(kernel, initialBindings) {
        ...
        const onKernelStatusChanged = (_, status) => {
...
/* harmony import */ var _status_panel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./status-panel */ "./lib/hydra-kernel/status-panel.js");
/* harmony import */ var _tokens__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tokens */ "./lib/hydra-kernel/tokens.js");
/* harmony import */ var _cell_metadata__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cell-metadata */ "./lib/hydra-kernel/cell-metadata.js");
/* harmony import */ var _toolbar_extension__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./toolbar-extension */ "./lib/hydra-kernel/toolbar-extension.js");
/* harmony import */ var _binding__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./binding */ "./lib/hydra-kernel/binding.js");
...
class HydraNotebookExtension {
    ...
    createNew(panel, context) {
        const cellMetadata = new _cell_metadata__WEBPACK_IMPORTED_MODULE_9__.CellMetadata();
        const switcher = new _toolbar_extension__WEBPACK_IMPORTED_MODULE_10__.CellBindingSwitcher(panel.content, cellMetadata);
        let bindings;
        ...
        const persistBindings = new _lumino_polling__WEBPACK_IMPORTED_MODULE_5__.Debouncer(() => {
            panel.model.metadata.set('hydra_bindings', (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_4__.toArray)(bindings).reduce((acc, binding) => {
        ...
        const fetchBindings = () => {
            ...
            else if (typeof storedBindings === 'object' &&
                storedBindings !== null) {
                ret = (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_4__.toArray)(Object.values(storedBindings));
            }
            return ret;
        };
...
const plugin = {
    ...
    autoStart: true,
    requires: [_tokens__WEBPACK_IMPORTED_MODULE_8__.IBindingRegistry],
...
const bindingRegistryPlugin = {
    ...
    autoStart: true,
    provides: _tokens__WEBPACK_IMPORTED_MODULE_8__.IBindingRegistry,
    activate() {
        return new _binding__WEBPACK_IMPORTED_MODULE_11__.BindingRegistry();
    }
};
const statusPlugin = {
    id: '@chameleoncloud/jupyterlab-chameleon:hydra-bindings',
    autoStart: true,
    requires: [_jupyterlab_application__WEBPACK_IMPORTED_MODULE_0__.ILabShell, _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_1__.INotebookTracker, _tokens__WEBPACK_IMPORTED_MODULE_8__.IBindingRegistry, _jupyterlab_translation__WEBPACK_IMPORTED_MODULE_2__.ITranslator],
    ...
    activate: (app, labshell, notebookTracker, bindingRegistry, translator, restorer) => {
        ...
        const widget = new _status_panel__WEBPACK_IMPORTED_MODULE_7__.BindingStatusPanel(labshell, notebookTracker, bindingRegistry, translator);
...
class BindingStatus extends react__WEBPACK_IMPORTED_MODULE_5__.Component {
    ...
    render() {
        ...
        const connectedStateIcon = (binding.progress.progress || '').toLowerCase() === 'busy'
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_lumino_signaling.1382e42aaf9dd54882c4.js.map