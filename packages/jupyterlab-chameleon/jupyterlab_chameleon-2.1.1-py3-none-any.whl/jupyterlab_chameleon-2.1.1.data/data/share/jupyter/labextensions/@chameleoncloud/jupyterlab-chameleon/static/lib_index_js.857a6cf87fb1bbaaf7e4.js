...
class BindingStatus extends react__WEBPACK_IMPORTED_MODULE_5__.Component {
    ...
    render() {
        ...
        const progressBarStyle = {
            width: `${(((_a = binding.progress) === null || _a === void 0 ? void 0 : _a.progressRatio) || 0.0) * 100}%`
        };
        const statusIcon = binding.state === 'connected'
            ? (((_b = binding.progress) === null || _b === void 0 ? void 0 : _b.progress) || '').toLowerCase() === 'busy'
            ...
            : _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_3__.offlineBoltIcon;
        return (react__WEBPACK_IMPORTED_MODULE_5__.createElement("div", { className: "chi-Binding", onClick: this.handleClick },
            react__WEBPACK_IMPORTED_MODULE_5__.createElement("div", { className: "chi-Binding-status" }, statusIcon),
            react__WEBPACK_IMPORTED_MODULE_5__.createElement("div", { className: "chi-Binding-summary" },
...
//# sourceMappingURL=lib_index_js.857a6cf87fb1bbaaf7e4.js.map