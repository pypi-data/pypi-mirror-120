...
_REMOTEJOB = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='hostname', full_name='remote.RemoteJob.hostname', index=5,
