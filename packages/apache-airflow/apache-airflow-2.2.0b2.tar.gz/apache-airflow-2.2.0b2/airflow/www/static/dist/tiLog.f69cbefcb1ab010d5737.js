...
/* harmony import */ var _meta_value__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
/*!
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const executionDate = Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('execution_date');
const dagId = Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('dag_id');
const taskId = Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('task_id');
const logsWithMetadataUrl = Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('logs_with_metadata_url');
const DELAY = parseInt(Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('delay'), 10);
const AUTO_TAILING_OFFSET = parseInt(Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('auto_tailing_offset'), 10);
const ANIMATION_SPEED = parseInt(Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('animation_speed'), 10);
const TOTAL_ATTEMPTS = parseInt(Object(_meta_value__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])('total_attempts'), 10);
  ...
  return Promise.resolve($.ajax({
    ...
    if (res.message) {
      ...
      res.message.forEach(item => {
        ...
        const escapedMessage = Object(_main__WEBPACK_IMPORTED_MODULE_1__["escapeHtml"])(item[1]);
        const linkifiedMessage = escapedMessage.replace(urlRegex, url => `<a href="${url}" target="_blank">${url}</a>`).replaceAll(dateRegex, date => `<span class="js-format-date">${Object(_datetime_utils__WEBPACK_IMPORTED_MODULE_0__[/* formatDateTime */ "c"])(`${date}+00:00`)}</span>`);
