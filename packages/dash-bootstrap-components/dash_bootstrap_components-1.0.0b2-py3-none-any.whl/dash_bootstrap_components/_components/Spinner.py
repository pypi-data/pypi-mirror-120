...
- type (string; default 'border'):
    ...
    'border'."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, fullscreen_style=Component.UNDEFINED, spinner_style=Component.UNDEFINED, fullscreen_class_name=Component.UNDEFINED, fullscreenClassName=Component.UNDEFINED, spinner_class_name=Component.UNDEFINED, spinnerClassName=Component.UNDEFINED, color=Component.UNDEFINED, type=Component.UNDEFINED, size=Component.UNDEFINED, fullscreen=Component.UNDEFINED, hide_delay=Component.UNDEFINED, show_delay=Component.UNDEFINED, show_initially=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'color', 'fullscreen', 'fullscreenClassName', 'fullscreen_class_name', 'fullscreen_style', 'hide_delay', 'show_delay', 'show_initially', 'size', 'spinnerClassName', 'spinner_class_name', 'spinner_style', 'type']
        self._type = 'Spinner'
        self._namespace = 'dash_bootstrap_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'color', 'fullscreen', 'fullscreenClassName', 'fullscreen_class_name', 'fullscreen_style', 'hide_delay', 'show_delay', 'show_initially', 'size', 'spinnerClassName', 'spinner_class_name', 'spinner_style', 'type']
