...
Original source: https://raw.githubusercontent.com/moby/moby/master/pkg/namesgenerator/names-generator.go
"""
...
def unique_name():
    ...
    formatted as "adjective_surname" with a random integer between 0 and 100
    added to the end.
    ...
    if adjective == 'boring' and surname == 'wozniak':
