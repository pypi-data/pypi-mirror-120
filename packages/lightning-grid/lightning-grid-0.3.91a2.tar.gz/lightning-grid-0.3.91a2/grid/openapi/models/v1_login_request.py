...
class V1LoginRequest(object):
    ...
    attribute_map = {'api_key': 'apiKey', 'duration': 'duration', 'username': 'username'}

    def __init__(self, api_key=None, duration=None, username=None, _configuration=None):  # noqa: E501
