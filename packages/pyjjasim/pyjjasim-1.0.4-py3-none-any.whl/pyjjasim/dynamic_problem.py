...
from pyjjasim.josephson_junction_array import Array
import numpy as np
import scipy.linalg
import scipy.sparse.linalg

from pyjjasim.static_problem import DefaultCurrentPhaseRelation

from pyjjasim.static_problem import StaticConfiguration, StaticProblem
from pyjjasim.stencil_derivative import stencil_derivative
...
class DynamicConfiguration:
    ...
    def plot(self, time_point=0, show_vortices=True, vortex_diameter=0.25, vortex_color=(0, 0, 0),
        ...
        from pyjjasim.array_visualize import ArrayPlot
    ...
    def animate(self, time_points=None, show_vortices=True,
        ...
        from pyjjasim.array_visualize import ArrayMovie
