...
class Property(
    ...
    def accept(self) -> typing.Optional[str]:
        assert self._accept is not self.__unset, "Uninitialized attribute"
        return self._accept

    @accept.setter
    def accept(self, accept: typing.Optional[str]):
        assert self._accept is self.__unset, "Immutable attribute"
...
class PropertiesMixin:
    ...
    def properties(self) -> PropertiesType:
        """ `properties` children """
        assert self._properties is not self.__unset, "Uninitialized attribute"
    ...
    def properties(self: typing.Union[ElementMixinProtocol, "PropertiesMixin"],
        ...
        assert self._properties is self.__unset, "Immutable attribute"
        if properties:
