...
class Option(
    ...
    def domain(self) -> str:
        """ `domain` attribute """
        assert self._domain is not self.__unset, "Uninitialized attribute"
        return self._domain

    @domain.setter
    def domain(self, domain: typing.Optional[str]):
        assert self._domain is self.__unset, "Immutable attribute"
        assert domain is None or isinstance(domain, str), "Invalid type"
    ...
    def domain_parts(self) -> typing.Tuple[str, typing.Optional[str]]:
        ...
        """
        assert self._domain_parts is not self.__unset, "Uninitialized attribute"
    ...
    def description(self) -> typing.Optional[str]:
        ...
        assert self._description is not self.__unset, "Uninitialized attribute"
        return self._description

    @description.setter
    def description(self, description: typing.Optional[str]):
        assert self._description is self.__unset, "Immutable attribute"
...
class OptionsMixin:
    ...
    def options(self) -> OptionsType:
        """ `options` children """
        assert self._options is not self.__unset, "Uninitialized attribute"
        return self._options

    @options.setter
    def options(self: typing.Union[ElementMixinProtocol, "OptionsMixin"],
                options: typing.Optional[typing.Iterable[Option]]):
        assert self._options is self.__unset, "Immutable attribute"
