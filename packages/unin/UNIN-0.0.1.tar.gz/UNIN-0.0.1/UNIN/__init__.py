...
#shows the license.
def license():
        print('Copyright (c) 2021- David Kundih. All rights reserved.\nLicensed under the Apache License, Version 2.0.\n\nFor more details about the license and terms of use visit the official alunari documentation linked at https://github.com/dkundih/alunariTools and https://pypi.org/project/alunariTools')

#shows the documentation.
def documentation():
        print('https://github.com/dkundih/alunariTools\nhttps://pypi.org/project/alunariTools')
...
def functions():
        print('alunariTools CALLABLE FUNCTIONS:\n')
