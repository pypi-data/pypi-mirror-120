...
kinparse could always use more documentation, whether as part of the
official kinparse docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `kinparse` repo on GitHub.
