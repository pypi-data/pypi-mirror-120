...
def start_session(*args, **kwargs):
    ...
    .. deprecated:: 1.8.3
        ...
        1. Please switch to using `client.connect()` as we may remove this
        in the future.
    ...
    :param bool show_login_url: Optional. When True and when using the SAM PKCE web authentication flow,
                                prints the login url that is used to establish a connection.
