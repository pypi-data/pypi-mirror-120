...
const releaseHealthRequest_1 = (0, tslib_1.__importDefault)(require("app/views/releases/utils/releaseHealthRequest"));
describe('ReleaseHealthRequest', function () {
    ...
    it('calculates correct session health data', function () {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let healthData;
            const wrapper = (0, enzyme_1.mountWithTheme)(<releaseHealthRequest_1.default releases={[
