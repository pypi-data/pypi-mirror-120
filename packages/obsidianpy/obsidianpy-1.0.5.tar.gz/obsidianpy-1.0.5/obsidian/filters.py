...
class Timescale(Filter):
    ...
    def __repr__(self):
        return f"<Obsidian.TimescaleFilter speed={self.speed} pitch={self.pitch} rate={self.rate}>"
...
class Karaoke(Filter):
    ...
    def __repr__(self):
        return f"<Obsidian.KaraokeFilter level={self.level} mono_level={self.mono_level} filter_band={self.filter_band} filter_width={self.filter_width}>"
...
class Tremolo(Filter):
    ...
    def __repr__(self):
        return f"<Obsidian.TremoloFilter frequency={self.frequency} depth={self.depth}>"
...
class Vibrato(Filter):
    ...
    def __repr__(self):
        return f"<Obsidian.VibratoFilter frequency={self.frequency} depth={self.depth}>"