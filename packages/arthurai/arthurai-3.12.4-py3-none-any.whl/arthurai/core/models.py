...
class ArthurModel(ArthurBaseJsonDataclass):
    ...
    def get_alerts(self, page: int = 1, page_size: int = 500, status: Optional[str] = None, alert_rule_id: Optional[str] = None, batch_id: Optional[str] = None, start_time: Optional[str] = None, end_time: Optional[str] = None) -> List[Alert]:
