...
project = u"sim_metrics"
copyright = u"2021, sim_metrics"
...
htmlhelp_basename = "sim_metricsdoc"
...
# [howto/manual]).
latex_documents = [
    (u"index", u"sim_metrics.tex",
     u"sim\_metrics Documentation",
     u"revesansparole",
     u"manual"),
]
...
man_pages = [
    (u"index", u"sim_metrics",
     u"sim_metrics Documentation",
     [u"revesansparole"], 1)
]
...
texinfo_documents = [
    (u"index", u"sim_metrics",
     ...
     u"revesansparole",
     u"sim_metrics",
     u"Set of metrics for evaluating simulation results",
     u"Miscellaneous"),
]
