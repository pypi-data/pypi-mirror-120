...
**sim_metrics** could always use more documentation, whether as
part of the official **sim_metrics** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `sim_metrics` for local
development.

1. Fork the `sim_metrics` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/sim_metrics.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd sim_metrics
    (dvlpt) sim_metrics$ flake8
    (dvlpt) sim_metrics$ pytest
    
    (dvlpt) sim_metrics$ tox
...
.. _issues: https://gitlab.com/revesansparole/sim_metrics/issues
