...
headers = {
        ...
        'Referer'   : "http://ocs.gz.cvte.cn/tv/pop/Tasks/create_pre_order_task/554977"
        # 'Accept': "*/*"
    }
...
def postHttpReqsToGetCustomerId(customer_name: str):
    url = "http://ocs.gz.cvte.cn/tv/Accounts/find_account"
    form_data_dict = {
...
def create_intention_order(order_subject ='自动创建订单' ,order_customer_id = '1917',order_customer_name = '青岛海尔电子有限公司'):
    ...
    :return:
    """
    intention_order_url = "http://ocs.gz.cvte.cn/tv/Reqs/submit_req_by_ajax/"
