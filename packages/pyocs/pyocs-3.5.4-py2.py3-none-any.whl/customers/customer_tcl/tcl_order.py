...
class TclOrder(object):
    ...
    _ocs_base_link = 'http://ocs.gz.cvte.cn'
    ...
    def get_tcl_sw_version_update_flag(self, ocs_number, tcl_sw_version):
        url = 'http://ocs.gz.cvte.cn/tv/TaskComments/get_all_task_comments_json/?order=DESC&task_id=' + ocs_number
    ...
    def query_my_order_and_set_comment(self, customer, engineer):
        ...
        if released_sw:
            ...
            print(released_sw)
            print(
                "已上传状态截图和自动上传软件，请登录ocs查看：" + "http://ocs.gz.cvte.cn/tv/Tasks/index/range:my/SearchId:" +
                searchid + Fore.WHITE)
