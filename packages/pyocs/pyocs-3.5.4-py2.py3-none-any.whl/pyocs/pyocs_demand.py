...
class PyocsDemand:
    ...
    def set_flag_color(self, flag_color):
        header = {
            'Host': 'ocs.gz.cvte.cn',
            'Referrer': 'http://ocs.gz.cvte.cn/tv/Tasks/view/' + str(self.ocs_number),
            'Origin': 'http://ocs.gz.cvte.cn'
        }
        setcolor_urL = "http://ocs.gz.cvte.cn/tv/Tasks/change_task_flag/" \
    ...
    def get_ddr_info(self):
        url = 'https://ocs.gz.cvte.cn/tv/Tasks/get_cplm_ic_storage_info_ajax/' + self.ocs_number
    ...
    def get_task_comment_area(self):
        url = 'http://ocs.gz.cvte.cn/tv/TaskComments/get_all_task_comments_json/?task_id=' + self.ocs_number + '&order=DESC'
    ...
    def get_number_by_product_batch_code(self, batch_code):
        ...
        search_response = PyocsRequest().pyocs_request_post("http://ocs.gz.cvte.cn/tv/Tasks", data=search_form_data, allow_redirects=True)
