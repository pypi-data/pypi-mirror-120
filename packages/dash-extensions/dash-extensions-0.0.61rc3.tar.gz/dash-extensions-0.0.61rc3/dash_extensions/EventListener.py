...
- delay (number; default 100):
    Number of milliseconds to wait before registering events handlers
    on children, defaults to 100.
...
- style (dict; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, events=Component.UNDEFINED, delay=Component.UNDEFINED, logging=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, event=Component.UNDEFINED, n_events=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'delay', 'event', 'events', 'logging', 'n_events', 'style']
        self._type = 'EventListener'
        self._namespace = 'dash_extensions'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'delay', 'event', 'events', 'logging', 'n_events', 'style']
