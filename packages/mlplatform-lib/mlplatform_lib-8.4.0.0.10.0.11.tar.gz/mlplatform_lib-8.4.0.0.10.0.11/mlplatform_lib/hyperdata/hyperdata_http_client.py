...
class HyperdataHttpClient:
    ...
    def get_do_list_by_datasource_id(self, auth: HyperdataUserAuth, datasource_id: int) -> DataObjectInfoList:
        ...
        return DataObjectInfoList(
            data_object_info_list=[
                from_dict(DataObject, do_info) for do_info in result_data
            ]
        )
    ...
    def get_dataobject_tables(
        ...
        return from_dict(DbSourceDataObjectCandidateList, result.data["dto"])
    ...
    def create_dataobjects(
        self, auth: HyperdataUserAuth, datasource_id: int, dataobjects: DataObjectInfoList
    ) -> None:
        return self.send_request(
            "dataobjects",
            {"datasources": datasource_id},
