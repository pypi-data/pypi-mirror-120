...
class SubClient(client.Client):
    ...
    def edit_profile(self,nickname: str = None,content: str = None,background_color: str = None):
        ...
        req= requests.post(f"https://aminoapps.com/api-p/x{self.comId}/s/user-profile/{self.profile.userId}",json=data,headers=self.web_headers)
        return req.json()
    ...
    def delete_message(self, chatId: str, messageId: str):
        self.web_headers["cookie"]=f"sid={headers.sid}"
        request = requests.delete(f"https://aminoapps.com/api-p/x{self.comId}/s/chat/thread/{chatId}/message/{messageId}",headers=self.web_headers)
        return request.json()
    ...
    def edit_chat(self,chatId: str,title: str = None,content: str = None,fans_only: bool = None):
        ...
        self.web_headers["cookie"]=f"sid={headers.sid}"
        request = requests.post(f"https://aminoapps.com/api-p/x{self.comId}/s/chat/thread/{chatId}",json=data,headers=self.web_headers)
        return request.json()
