...
class RenderSequencePlayblasts(ProcessSequenceFiles):
    ...
    def submit_afterfx_playblast_job(self, shot_name, dept_name, file_name, revision_name, priority=10, pool_name='default'):
        ...
        file.submit_aftereffects_playblast_job.revision_name.set(revision_name)
        file.submit_aftereffects_playblast_job.priority.set(priority)
        file.submit_aftereffects_playblast_job.pool.set(pool_name)
        file.submit_aftereffects_playblast_job.run('Submit job')
