...
__all__ = ['ProgressPercentage', 'TSBenchmarks']
...
class TSBenchmarks:
    ...
    def __init__(self, bucket_name: str,
                 ...
                 aws_access_key_id: str,
                 aws_secret_access_key: str) -> 'TSBenchmarks':
    ...
    def _evaluate_forecasts(self, s3_uri: str,
                            dataset: str = 'M4-Daily',
        ...
        """
        query = dict(url=s3_uri, dataset=dataset,
    ...
    def evaluate_my_model(self, s3_uri: str,
                          dataset: str,
                          unique_id_column: str = 'unique_id',
                          ds_column: str = 'ds',
                          y_column: str = 'y') -> pd.DataFrame:
        """Evaluate forecasts from S3 URL.
        ...
        return self._evaluate_forecasts(s3_uri=s3_uri,
                                        dataset=dataset,
                                        unique_id_column=unique_id_column,
                                        ds_column=ds_column,
                                        y_column=y_column)
    ...
    def get_status(self, job_id: str) -> pd.DataFrame:
        ...
        ----------
        job_id: str
            ID job from `evaluate_my_model`.
        """
        resp = requests.get(f'{self.invoke_url}/tsbenchmarks/jobs/',
