...
# This version is used to determine cli extension compatibility, update this when publishing to pypi
__version__ = "2.25.0.5"

# This is the version shown to users, update this when making a msgraph-cli release
__msgraph_cli_version__ = "0.2.0"
