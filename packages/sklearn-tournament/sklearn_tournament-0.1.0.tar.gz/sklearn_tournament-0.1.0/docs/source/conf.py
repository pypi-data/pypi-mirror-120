...
package_dir = os.path.abspath(os.path.join(project_dir, "sklearn_tournament"))

sys.path.insert(0, project_dir)

import sklearn_tournament  # noqa: E402

# -- Project information -----------------------------------------------------

# General information about the project.
project = "sklearn-tournament"
author = sklearn_tournament.__author__
copyright = "2021, " + sklearn_tournament.__author__
...
version = sklearn_tournament.__version__
# The full version, including alpha/beta/rc tags.
release = sklearn_tournament.__version__
...
html_theme_options = {
    ...
    "fixed_sidebar": "true",
    "github_user": "sheypex",
    "github_repo": "sklearn-tournament",
    "github_banner": "true",
    "github_button": "true",
    "github_type": "star",
