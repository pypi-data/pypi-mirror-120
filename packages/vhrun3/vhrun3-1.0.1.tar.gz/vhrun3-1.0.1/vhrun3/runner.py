...
class HttpRunner(object):
    ...
    def __run_step_request(self, step: TStep, protocol=None) -> StepData:
        ...
        if protocol is None:
            ...
            response_obj = resp_obj.resp_obj
        else:
            ...
            # parsed_test_connection = self.session_context.eval_content(raw_connection)
            try:
                # ssh connection
                ...
                if ssh_type == "shell":
                    ...
                    local_path, remote_path = step.paths
                    parsed_request_dict = {"local_path": os.path.join(os.getcwd(), local_path),
                                           "remote_path": os.path.join(os.getcwd(), remote_path)}
                else:
        ...
        try:
            ...
            self.__session.data.attachment = str(e)
            self.__ssh.data.attachment = str(e)
            session_success = False
            ...
            if hasattr(self.__session, "data") and protocol is None:
                ...
                # {"success": step_data.success, "request": parsed_request_dict, "response": response}
        ...
        self.__ssh.data.attachment = self.__session.data.attachment = ""  # 这句很重要，不然attachment会印象别的case
    ...
    def start_run(self, param: Dict = None) -> "HttpRunner":
        ...
        try:
            ...
            aggregated_summary, flag = aggregate(summary, self.config.path)
