...
# df = ng.get_k_data(code='000058.SH',freq='d',end='2020-05-15',bars=30)
# print(df)
...
# print(price)
# aasd = price.loc[1]['nowv']
# print(aasd,type(aasd))
...
# df = ng.get_allStockData(codes=['002153.SZ','300856.SZ','688580.SH'])
# print(df)
