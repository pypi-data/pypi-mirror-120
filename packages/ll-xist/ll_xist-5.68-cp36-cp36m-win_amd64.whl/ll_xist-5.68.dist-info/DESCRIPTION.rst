...
* Added the following three methods to ``ll.orasql.Table``:
  ...
  * ``ll.orasql.Table.uniques`` returns all unique contraints for the table;
  * ``ll.orasql.Table.checks`` returns all check contraints for the table.
...
* Removed the ancient XIST namespace modules ``ll.xist.ns.kid`` and
  ``ll.xist.ns.ihtml``.
