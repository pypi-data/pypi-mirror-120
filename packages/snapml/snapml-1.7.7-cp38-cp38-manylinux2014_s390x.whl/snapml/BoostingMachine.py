...
class BoostingMachine:
    ...
    def __init__(self, params=None):
        ...
        if params is not None:
            ...
            if (
                self.params_["boosting_params"]["max_max_depth"]
                < self.params_["boosting_params"]["min_max_depth"]
            ):
                raise ValueError(
    ...
    def _import_model(self, input_file, input_type):
        ...
        self.model_, self.model_size_, self.n_classes_ = libsnapml.booster_import(
