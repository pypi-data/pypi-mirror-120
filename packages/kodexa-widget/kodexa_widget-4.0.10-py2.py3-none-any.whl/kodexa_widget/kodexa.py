...
class KodexaDocumentWidget(VueTemplate):
    ...
    options = traitlets.Dict({}).tag(sync=True)
    document_family = traitlets.Dict(None, allow_none=True).tag(sync=True)
    ...
    def __init__(self, document, document_family=None, width=None, height=None, mixin=None, options=None,
                 tags=None):
        ...
        self.document_bytes = document.to_kddb()
        self.width = width
        self.height = height
        self.mixin = mixin
        self.options = options
