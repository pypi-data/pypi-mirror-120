...
class ZeroEx:
    ...
    # /swap/v1/price
    def get_price(self, sellAmountInWei, sellToken, buyToken, takerAddress=None, affiliateAddress=None):
        qs = {
            'sellToken': sellToken,
            'buyToken': buyToken,
    ...
    def get_prices(self, sellToken="WETH"):
        ...
        return self.request('GET', '/swap/v1/prices', qs)

    # /swap/v1/tokens
    def get_tokens(self):
        return self.request('GET', '/swap/v1/tokens', None)
