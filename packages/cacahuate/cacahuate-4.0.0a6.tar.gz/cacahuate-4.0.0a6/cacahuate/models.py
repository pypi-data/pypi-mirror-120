...
class CustomSetRelation(fields.SetRelation):
    def __init__(self, *args, **kwargs):
        super(CustomSetRelation, self).__init__(*args, **kwargs)
        self.default = []
...
class Execution(Model):
    ...
    pointers = CustomSetRelation(
        'cacahuate.models.Pointer',
        inverse='execution'
    )
    actors = CustomSetRelation(
...
class User(Model):
    ...
    activities = CustomSetRelation(
        'cacahuate.models.Execution',
        inverse='actors'
    )
    # pending tasks to solve
    tasks = CustomSetRelation(
        'cacahuate.models.Pointer',
        inverse='candidates'
    )
