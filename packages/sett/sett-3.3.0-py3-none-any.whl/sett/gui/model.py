...
from .ui_model_bind import ClassWithListener, DictWithListener
from ..core.crypt import gpg
from ..core.metadata import Purpose
from ..utils.config import Config
from ..protocols import Protocol, protocols, sftp
...
def protocol_factory():
    return {p: DictWithListener() for p in protocols}
...
class AppData(ClassWithListener):
    ...
    transfer_protocol_args: Dict = field(default_factory=protocol_factory)
