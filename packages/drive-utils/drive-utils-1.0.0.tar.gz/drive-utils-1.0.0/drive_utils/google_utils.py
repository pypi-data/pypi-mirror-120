# Importando funções e objetos do Google
...
class DriveUtils:
    def __init__(self, project_id: str, client_id:str, client_email:str, client_x509_cert_url:str, private_key_id: str, private_key: str) -> None:
        ...
        drive_credentials = __get_drive_credentials(project_id, client_id, client_email, client_x509_cert_url, private_key_id, private_key)
