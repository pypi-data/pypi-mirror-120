"""Utility methods for climaticai objectives."""
from .objective_base import ObjectiveBase

from climaticai import objectives
from climaticai.exceptions import ObjectiveCreationError, ObjectiveNotFoundError
from climaticai.problem_types import handle_problem_types
from climaticai.utils.gen_utils import _get_subclasses
...
def _all_objectives_dict():
    ...
    for objective in all_objectives:
        if "climaticai.objectives" not in objective.__module__:
            continue
...
def get_objective(objective, return_instance=False, **kwargs):
    ...
    if objective.lower() not in all_objectives_dict:
        raise ObjectiveNotFoundError(
            ...
            "Use climaticai.objectives.get_all_objective_names()"
