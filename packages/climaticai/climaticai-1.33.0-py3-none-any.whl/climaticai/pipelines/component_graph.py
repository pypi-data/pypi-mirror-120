...
from climaticai.exceptions.exceptions import (
    MethodPropertyNotFoundError,
    MissingComponentError,
    ParameterNotUsedWarning,
)
from climaticai.pipelines.components import ComponentBase, Estimator, Transformer
from climaticai.pipelines.components.transformers.transformer import (
    TargetTransformer,
)
from climaticai.pipelines.components.utils import handle_component_class
from climaticai.utils import import_or_raise, infer_feature_types
from climaticai.utils.logger import get_logger
    ...
    def __repr__(self):
        ...
        for (
            ...
            try:
                ...
                # Not an climaticai component, use component class name
