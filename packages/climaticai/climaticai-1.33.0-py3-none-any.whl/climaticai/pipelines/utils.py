"""Utility methods for climaticai pipelines."""
import logging
...
from climaticai.data_checks import DataCheckActionCode, TargetDistributionDataCheck
from climaticai.model_family import ModelFamily
from climaticai.pipelines.components import (  # noqa: F401
    CatBoostClassifier,
    CatBoostRegressor,
    ComponentBase,
    DateTimeFeaturizer,
...
from climaticai.utils import import_or_raise, infer_feature_types
...
def generate_pipeline_code(element):
    """Creates and returns a string that contains the Python imports and code required for running the climaticai pipeline.
