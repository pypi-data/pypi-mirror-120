...
from climaticai.model_family.model_family import ModelFamily
from climaticai.model_understanding.prediction_explanations._algorithms import (
...
from climaticai.pipelines.components.utils import _all_estimators_used_in_search
from climaticai.pipelines.utils import make_pipeline
from climaticai.problem_types.problem_types import ProblemTypes
...
@patch(
    "climaticai.model_understanding.prediction_explanations._algorithms.shap.TreeExplainer"
)
...
@patch("climaticai.model_understanding.prediction_explanations._algorithms.logger")
