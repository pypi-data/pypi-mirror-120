...
from climaticai.model_understanding.prediction_explanations.explainers import (
...
@patch("climaticai.model_understanding.prediction_explanations.explainers.DEFAULT_METRICS")
@patch(
    "climaticai.model_understanding.prediction_explanations._user_interface._make_single_prediction_shap_table"
)
