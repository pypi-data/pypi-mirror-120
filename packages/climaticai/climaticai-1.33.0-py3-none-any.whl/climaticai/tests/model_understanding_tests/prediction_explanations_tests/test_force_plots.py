...
from climaticai.model_understanding.force_plots import force_plot, graph_force_plot
from climaticai.pipelines import (
    BinaryClassificationPipeline,
    MulticlassClassificationPipeline,
    RegressionPipeline,
)
from climaticai.tests.model_understanding_tests.prediction_explanations_tests.test_explainers import (
    pipeline_test_cases,
...
@patch("climaticai.model_understanding.force_plots.jupyter_check")
@patch("climaticai.model_understanding.force_plots.initjs")
