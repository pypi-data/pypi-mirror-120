...
from climaticai.tuners import ParameterError, Tuner
from climaticai.tuners.skopt_tuner import SKOptTuner
...
def test_skopt_tuner_invalid_parameters_score():
    ...
    with patch("climaticai.tuners.skopt_tuner.Optimizer.tell") as mock_optimizer_tell:
