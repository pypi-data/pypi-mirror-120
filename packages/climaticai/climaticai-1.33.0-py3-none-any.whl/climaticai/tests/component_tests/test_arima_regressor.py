...
from climaticai.pipelines.components import ARIMARegressor
...
@patch(
    "climaticai.pipelines.components.estimators.regressors.arima_regressor.ARIMARegressor._format_dates"
)
@patch(
    "climaticai.pipelines.components.estimators.regressors.arima_regressor.ARIMARegressor._get_dates"
)
