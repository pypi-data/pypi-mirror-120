...
from climaticai.pipelines import LightGBMClassifier
from climaticai.problem_types import ProblemTypes
from climaticai.utils import SEED_BOUNDS
...
@patch("climaticai.pipelines.components.estimators.estimator.Estimator.predict_proba")
@patch("climaticai.pipelines.components.estimators.estimator.Estimator.predict")
