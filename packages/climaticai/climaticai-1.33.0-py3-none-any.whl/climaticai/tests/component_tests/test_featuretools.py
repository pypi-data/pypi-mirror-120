...
from climaticai.pipelines.components import DFSTransformer
...
@patch("climaticai.pipelines.components.transformers.preprocessing.featuretools.dfs")
@patch(
    "climaticai.pipelines.components.transformers.preprocessing.featuretools.calculate_feature_matrix"
)
