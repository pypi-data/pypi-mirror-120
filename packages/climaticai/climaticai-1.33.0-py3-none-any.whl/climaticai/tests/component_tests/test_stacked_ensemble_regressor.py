...
@patch(
    "climaticai.pipelines.components.ensemble.SklearnStackedEnsembleRegressor._stacking_estimator_class"
)
...
@patch("climaticai.pipelines.components.ensemble.SklearnStackedEnsembleRegressor.fit")
