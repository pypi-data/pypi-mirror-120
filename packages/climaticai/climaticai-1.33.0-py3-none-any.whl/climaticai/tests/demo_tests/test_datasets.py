...
def test_techsprint2021(techsprint2021_local):
    X, y = techsprint2021_local
...
@pytest.mark.skip_offline
def test_techsprint2021_data(techsprint2021_local):
    X, y = demos.load_techsprint2021()
    X_local, y_local = techsprint2021_local
    pd.testing.assert_frame_equal(X, X_local)
    pd.testing.assert_series_equal(y, y_local)
