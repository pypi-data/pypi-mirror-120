...
from climaticai import AutoMLSearch
from climaticai.automl.automl_algorithm import IterativeAlgorithm
from climaticai.automl.automl_search import build_engine_from_str
from climaticai.automl.callbacks import (
    log_error_callback,
    raise_error_callback,
    silent_error_callback,
)
from climaticai.automl.engine import CFEngine, DaskEngine, SequentialEngine
from climaticai.automl.utils import (
    _LARGE_DATA_PERCENT_VALIDATION,
    _LARGE_DATA_ROW_THRESHOLD,
    get_default_primary_search_objective,
    get_pipelines_from_component_graphs,
)
from climaticai.exceptions import (
...
from climaticai.objectives import (
    F1,
...
from climaticai.objectives.utils import (
    get_all_objective_names,
    get_core_objectives,
    get_non_core_objectives,
    get_objective,
)
from climaticai.pipelines import (
...
from climaticai.pipelines.components.utils import (
    allowed_model_families,
    get_estimators,
)
from climaticai.pipelines.utils import make_pipeline
from climaticai.preprocessing import TrainingValidationSplit
from climaticai.problem_types import (
    ProblemTypes,
    handle_problem_types,
    is_classification,
    is_time_series,
)
from climaticai.tests.automl_tests.parallel_tests.test_automl_dask import (
    engine_strs,
)
from climaticai.tests.conftest import CustomClassificationObjectiveRanges
from climaticai.tuners import NoParamsException, RandomSearchTuner, SKOptTuner
...
@patch("climaticai.objectives.AUC.score")
...
@patch("climaticai.tuners.random_search_tuner.RandomSearchTuner.is_search_space_exhausted")
...
@patch("climaticai.automl.automl_algorithm.IterativeAlgorithm.next_batch")
...
@patch("climaticai.automl.automl_algorithm.IterativeAlgorithm.__init__")
...
@patch("climaticai.automl.automl_search.AutoMLSearch.search")
...
@patch("climaticai.automl.engine.sequential_engine.SequentialComputation.get_result")
...
@patch("builtins.input")
@patch("climaticai.automl.engine.sequential_engine.SequentialComputation.done")
...
@patch(
    "climaticai.automl.engine.sequential_engine.SequentialComputation.done",
    side_effect=KeyboardInterruptOnKthPipeline(k=4, starting_index=2),
)
@patch("climaticai.automl.engine.sequential_engine.SequentialComputation.cancel")
...
@patch("climaticai.automl.automl_algorithm.IterativeAlgorithm.next_batch")
@patch("climaticai.automl.AutoMLSearch.full_rankings", new_callable=PropertyMock)
@patch("climaticai.automl.AutoMLSearch.rankings", new_callable=PropertyMock)
...
@patch("climaticai.automl.engine.engine_base.split_data")
...
@patch("climaticai.tuners.skopt_tuner.Optimizer.tell")
def test_percent_better_than_baseline_in_rankings(
    ...
    baseline_pipeline_class = {
        ProblemTypes.BINARY: "climaticai.pipelines.BinaryClassificationPipeline",
        ProblemTypes.MULTICLASS: "climaticai.pipelines.MulticlassClassificationPipeline",
        ProblemTypes.REGRESSION: "climaticai.pipelines.RegressionPipeline",
        ProblemTypes.TIME_SERIES_REGRESSION: "climaticai.pipelines.TimeSeriesRegressionPipeline",
    }[problem_type_value]
...
@patch("climaticai.pipelines.BinaryClassificationPipeline.fit")
@patch("climaticai.pipelines.MulticlassClassificationPipeline.fit")
@patch("climaticai.pipelines.RegressionPipeline.fit")
@patch("climaticai.pipelines.TimeSeriesRegressionPipeline.fit")
@patch("climaticai.tuners.skopt_tuner.Optimizer.tell")
...
@patch("climaticai.tuners.skopt_tuner.SKOptTuner.add")
...
@patch("climaticai.objectives.BinaryClassificationObjective.optimize_threshold")
...
@patch("climaticai.automl.engine.sequential_engine.train_pipeline")
...
def test_automl_issues_beta_warning_for_time_series(problem_type, X_y_binary):
    ...
    with warnings.catch_warnings(record=True) as warn:
        ...
        assert len(warn) == 1
        message = "Time series support in climaticai is still in beta, which means we are still actively building its core features"
...
@pytest.mark.parametrize("verbose", [True, False])
@patch(
    "climaticai.objectives.binary_classification_objective.BinaryClassificationObjective.optimize_threshold",
    return_value=0.65,
)
...
@patch("climaticai.objectives.standard_metrics.F1.optimize_threshold", return_value=0.42)
...
@patch(
    "climaticai.data_checks.target_distribution_data_check.TargetDistributionDataCheck.validate"
)
...
@patch("climaticai.pipelines.components.Estimator.fit")
@patch(
    "climaticai.pipelines.BinaryClassificationPipeline.score",
