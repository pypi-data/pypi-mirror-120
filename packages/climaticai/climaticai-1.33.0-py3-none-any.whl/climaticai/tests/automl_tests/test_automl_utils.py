...
from climaticai.objectives import F1, R2, LogLossBinary, LogLossMulticlass
from climaticai.pipelines import (
    BinaryClassificationPipeline,
    MulticlassClassificationPipeline,
    RegressionPipeline,
)
from climaticai.preprocessing.data_splitters import (
    TimeSeriesSplit,
    TrainingValidationSplit,
)
from climaticai.problem_types import ProblemTypes
from climaticai.utils.woodwork_utils import infer_feature_types
...
@patch(
    "climaticai.pipelines.BinaryClassificationPipeline._encode_targets",
