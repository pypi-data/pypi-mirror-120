...
from climaticai.automl.automl_algorithm import (
...
from climaticai.pipelines.components import Estimator
...
@patch(
    "climaticai.pipelines.components.ensemble.SklearnStackedEnsembleClassifier._stacking_estimator_class"
)
