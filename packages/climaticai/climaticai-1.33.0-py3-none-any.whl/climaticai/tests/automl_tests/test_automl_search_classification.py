...
from climaticai.automl.automl_algorithm import DefaultAlgorithm, IterativeAlgorithm
from climaticai.automl.callbacks import raise_error_callback
from climaticai.automl.pipeline_search_plots import SearchIterationPlot
from climaticai.automl.utils import get_best_sampler_for_data
from climaticai.exceptions import ParameterNotUsedWarning, PipelineNotFoundError
...
from climaticai.pipelines.components.utils import get_estimators
from climaticai.pipelines.utils import make_pipeline
from climaticai.preprocessing import TimeSeriesSplit, split_data
...
@patch("climaticai.pipelines.components.estimators.Estimator.fit")
@patch(
    "climaticai.pipelines.BinaryClassificationPipeline.score",
    return_value={"Log Loss Binary": 0.5},
)
@patch(
    "climaticai.pipelines.MulticlassClassificationPipeline.score",
