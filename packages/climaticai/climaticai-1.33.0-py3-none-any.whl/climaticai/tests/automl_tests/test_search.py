...
from climaticai.automl import AutoMLSearch, search
from climaticai.automl.automl_algorithm import DefaultAlgorithm
from climaticai.utils import infer_feature_types


@patch("climaticai.data_checks.default_data_checks.DefaultDataChecks.validate")
@patch("climaticai.automl.AutoMLSearch.search")
