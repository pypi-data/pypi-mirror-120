...
from climaticai.exceptions import PipelineScoreError
from climaticai.objectives import FraudCost, get_objective
from climaticai.pipelines import BinaryClassificationPipeline
...
@patch("climaticai.pipelines.ClassificationPipeline._decode_targets", return_value=[0, 1])
@patch(
    "climaticai.objectives.BinaryClassificationObjective.decision_function",
...
@patch("climaticai.pipelines.ComponentGraph._compute_features")
...
@patch("climaticai.pipelines.BinaryClassificationPipeline.score")
@patch("climaticai.pipelines.BinaryClassificationPipeline.predict_proba")
