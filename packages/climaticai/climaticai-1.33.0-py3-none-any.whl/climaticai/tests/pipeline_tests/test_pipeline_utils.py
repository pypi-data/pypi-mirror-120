...
from climaticai.data_checks import DataCheckAction, DataCheckActionCode
...
from climaticai.pipelines.utils import (
...
from climaticai.problem_types import ProblemTypes, is_regression, is_time_series
        ...
        X_all = pd.DataFrame(
            {
                ...
                * 2,
                ...
                "text": [
                    ...
                    "climaticai should handle string input",
                    "cats are gr8",
                    "hello world",
                    "climaticai is gr8",
                ]
                * 2,
                "email": [
                    ...
                    "fooEMAIL@email.org",
                    "climaticai@climaticai.org",
                    "climaticai@alteryx.org",
                ]
                * 2,
                "url": [
                    ...
                    "https://github.com/alteryx/climaticai",
...
def test_generate_code_pipeline_json_with_objects():
    ...
    assert (
        ...
        == "from climaticai.pipelines.binary_classification_pipeline import BinaryClassificationPipeline\n"
...
def test_generate_code_pipeline():
    ...
    expected_code = (
        "from climaticai.pipelines.regression_pipeline import RegressionPipeline\n"
