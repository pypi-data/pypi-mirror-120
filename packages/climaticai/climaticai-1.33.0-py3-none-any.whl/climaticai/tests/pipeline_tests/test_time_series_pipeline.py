...
from climaticai.exceptions import PipelineNotYetFittedError
from climaticai.objectives import FraudCost, get_objective
from climaticai.pipelines import (
    TimeSeriesBinaryClassificationPipeline,
    TimeSeriesMulticlassClassificationPipeline,
    TimeSeriesRegressionPipeline,
)
from climaticai.pipelines.components import DelayedFeatureTransformer, Transformer
from climaticai.pipelines.utils import _get_pipeline_base_class
from climaticai.preprocessing.utils import is_classification
...
@patch("climaticai.pipelines.components.RandomForestRegressor.fit")
@patch("climaticai.pipelines.components.RandomForestClassifier.fit")
@patch(
    "climaticai.pipelines.TimeSeriesClassificationPipeline._encode_targets",
...
@patch("climaticai.pipelines.components.RandomForestClassifier.predict")
@patch("climaticai.pipelines.components.RandomForestRegressor.predict")
...
@patch("climaticai.pipelines.components.RandomForestRegressor.fit")
@patch("climaticai.pipelines.components.RandomForestRegressor.predict")
@patch("climaticai.pipelines.components.LogisticRegressionClassifier.fit")
@patch("climaticai.pipelines.components.LogisticRegressionClassifier.predict")
@patch(
    "climaticai.pipelines.TimeSeriesClassificationPipeline._encode_targets",
    side_effect=lambda y: y,
)
@patch(
    "climaticai.pipelines.TimeSeriesClassificationPipeline._decode_targets",
    side_effect=lambda y: y,
)
@patch("climaticai.pipelines.PipelineBase._score_all_objectives")
@patch("climaticai.pipelines.TimeSeriesBinaryClassificationPipeline._score_all_objectives")
def test_score(
    mock_binary_score,
    mock_score,
    mock_encode_targets,
...
@patch("climaticai.pipelines.LogisticRegressionClassifier.fit")
@patch("climaticai.pipelines.LogisticRegressionClassifier.predict_proba")
@patch("climaticai.pipelines.LogisticRegressionClassifier.predict")
@patch("climaticai.pipelines.TimeSeriesClassificationPipeline._score_all_objectives")
@patch("climaticai.pipelines.ClassificationPipeline._decode_targets")
@patch("climaticai.pipelines.ClassificationPipeline._encode_targets")
...
@patch("climaticai.pipelines.TimeSeriesClassificationPipeline._decode_targets")
@patch("climaticai.objectives.BinaryClassificationObjective.decision_function")
@patch("climaticai.pipelines.components.Estimator.predict_proba")
@patch(
    "climaticai.pipelines.components.Estimator.predict",
...
def test_time_series_pipeline_not_fitted_error(
    ...
    if is_classification(problem_type):
        to_patch = "climaticai.pipelines.TimeSeriesClassificationPipeline.predict_in_sample"
        if problem_type == ProblemTypes.TIME_SERIES_BINARY:
            to_patch = "climaticai.pipelines.TimeSeriesBinaryClassificationPipeline.predict_in_sample"
...
@patch("climaticai.objectives.FraudCost.decision_function")
...
@patch("climaticai.pipelines.LogisticRegressionClassifier.fit")
@patch("climaticai.pipelines.components.ElasticNetRegressor.fit")
...
@patch("climaticai.pipelines.components.Imputer.transform")
@patch("climaticai.pipelines.components.OneHotEncoder.transform")
@pytest.mark.parametrize(
    "problem_type",
    [
        ProblemTypes.TIME_SERIES_BINARY,
