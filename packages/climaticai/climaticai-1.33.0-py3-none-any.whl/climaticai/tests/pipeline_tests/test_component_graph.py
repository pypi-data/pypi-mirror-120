...
from climaticai.pipelines import ComponentGraph
...
from climaticai.pipelines.components.transformers.transformer import (
    TargetTransformer,
)
...
@patch("climaticai.pipelines.components.Transformer.fit_transform")
...
@patch("climaticai.pipelines.components.TargetImputer.fit_transform")
@patch("climaticai.pipelines.components.OneHotEncoder.fit_transform")
...
@patch("climaticai.pipelines.components.Imputer.fit_transform")
...
@patch("climaticai.pipelines.components.estimators.LogisticRegressionClassifier.fit")
...
@patch("climaticai.pipelines.components.Imputer.transform")
@patch("climaticai.pipelines.components.OneHotEncoder.transform")
@patch("climaticai.pipelines.components.TargetImputer.transform")
