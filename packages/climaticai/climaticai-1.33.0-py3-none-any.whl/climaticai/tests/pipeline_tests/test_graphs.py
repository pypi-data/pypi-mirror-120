...
from climaticai.pipelines import BinaryClassificationPipeline, ComponentGraph
...
@patch("climaticai.pipelines.pipeline_base.jupyter_check")
@patch("climaticai.pipelines.pipeline_base.import_or_raise")
