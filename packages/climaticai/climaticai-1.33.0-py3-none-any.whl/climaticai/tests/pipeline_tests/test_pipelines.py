...
from climaticai.pipelines.component_graph import ComponentGraph
from climaticai.pipelines.components import (
    DropNullColumns,
    DropRowsTransformer,
...
@patch("climaticai.pipelines.RegressionPipeline.predict")
...
@patch("climaticai.pipelines.ComponentGraph.fit")
@patch("climaticai.pipelines.RegressionPipeline.predict")
...
@patch("climaticai.pipelines.BinaryClassificationPipeline._encode_targets")
@patch("climaticai.pipelines.BinaryClassificationPipeline.fit")
@patch("climaticai.pipelines.components.Estimator.predict")
...
@patch("climaticai.pipelines.MulticlassClassificationPipeline._encode_targets")
...
@patch("climaticai.pipelines.MulticlassClassificationPipeline._encode_targets")
@patch("climaticai.pipelines.MulticlassClassificationPipeline.fit")
@patch("climaticai.pipelines.ComponentGraph.predict")
...
@patch("climaticai.objectives.R2.score")
@patch("climaticai.pipelines.RegressionPipeline.fit")
@patch("climaticai.pipelines.RegressionPipeline.predict")
...
@patch("climaticai.pipelines.BinaryClassificationPipeline._encode_targets")
@patch("climaticai.objectives.F1.score")
@patch("climaticai.pipelines.BinaryClassificationPipeline.fit")
@patch("climaticai.pipelines.components.Estimator.predict")
...
@patch("climaticai.pipelines.MulticlassClassificationPipeline._encode_targets")
@patch("climaticai.objectives.F1Micro.score")
@patch("climaticai.pipelines.MulticlassClassificationPipeline.fit")
@patch("climaticai.pipelines.components.Estimator.predict")
...
@patch("climaticai.pipelines.components.StandardScaler.transform")
...
@patch("climaticai.pipelines.components.Imputer.transform")
@patch("climaticai.pipelines.components.OneHotEncoder.transform")
@patch("climaticai.pipelines.components.RandomForestClassifier.predict_proba")
@patch("climaticai.pipelines.components.ElasticNetClassifier.predict_proba")
@patch("climaticai.pipelines.components.RandomForestClassifier.predict")
@patch("climaticai.pipelines.components.ElasticNetClassifier.predict")
...
def test_pipeline_not_fitted_error(
    ...
    if is_classification(problem_type):
        to_patch = "climaticai.pipelines.ClassificationPipeline._predict"
        if problem_type == ProblemTypes.BINARY:
            to_patch = "climaticai.pipelines.BinaryClassificationPipeline._predict"
...
@patch("climaticai.pipelines.PipelineBase.fit")
@pytest.mark.parametrize(
    "problem_type",
    [ProblemTypes.BINARY, ProblemTypes.MULTICLASS, ProblemTypes.REGRESSION],
)
def test_nonlinear_pipeline_not_fitted_error(
    ...
    clf.fit(X, y)
    if problem_type in [ProblemTypes.BINARY, ProblemTypes.MULTICLASS]:
        with patch("climaticai.pipelines.ClassificationPipeline.predict") as mock_predict:
            clf.predict(X)
            mock_predict.assert_called()
        with patch(
            "climaticai.pipelines.ClassificationPipeline.predict_proba"
        ) as mock_predict_proba:
            clf.predict_proba(X)
            mock_predict_proba.assert_called()
    else:
        with patch("climaticai.pipelines.RegressionPipeline.predict") as mock_predict:
            clf.predict(X)
            mock_predict.assert_called()
    clf.feature_importance
