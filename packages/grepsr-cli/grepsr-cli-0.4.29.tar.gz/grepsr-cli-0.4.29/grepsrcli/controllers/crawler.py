...
from ..core.utils import create_boilerplate, get_plugin_info, get_plugin_path, show_schema
...
class Crawler(Controller):
    ...
    def update(self):
        # composer update
        package_url = 'https://crawler-plugins.s3.amazonaws.com/php/vortex-plugins-services-base/amazon_pdp/amazon_pdp-0.0.1.tar.gz'
