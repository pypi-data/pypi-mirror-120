...
def draw_geometric_phantom_image_filter(*args: itkt.ImageLike,  geometric_phantom=..., config_file: str=..., phantom_scale: Sequence[float]=..., origin_offset: Sequence[float]=..., is_forbild_config_file: bool=..., rotation_matrix=..., clip_planes=...,**kwargs)-> itkt.ImageSourceReturn:
