...
class VIP:
    ...
    def load_object(self, path=None,
        ...
        """
        Load an OBJ file into VIP.

        :param path: :class:`str` Desired path of the OBJ file (must be local to machine running VIP instance).
        """
    ...
    def switch_object(self, id:str):
        """
        Switches the current Object context in VIP.

        :param id: :class:`str` id of the object (as provided by VIP).
        :return: :class:`None`
        """
    ...
    def delete_object(self, id=None):
        """
        Delete an object in VIP, given an id. If no id is passed, VIP will delete the current object.
        """
        ...
        if id is None:
            ...
            if not isinstance(id, str):
                utils.rais_invalid_argument_exception(str(type(id)), "id", 
                                                    "must be a `str` specifying the id of an object loaded into VIP.")
    ...
    def delete_all_objects(self):
        """
        Deletes all objects loaded into VIP.
        """
        params = {"TaskType": "DeleteOBJ"}
    ...
    def refresh_plot(self, export="ortho", background="white", imsize=(2048, 2048), path=None):
        """
        Requests VIP to refresh the current plot. This is the equivalent of pressing the Plot button again. It may be helpful to use this to refresh the 
    ...
    def create_custom_dashboard(self, name=None):
        """
        Create a new VipDashboard instance in VIP.
    ...
    def clear_custom_dashboard(self, guid=None):
        """
        Clears all VipDashboardTiles from a VipDashboard instance in VIP.
    ...
    def set_current_dashboard(self, guid=None):
        """
        Sets the current VipDashboard in the dashboard window in VIP, based on the specified GUID.
    ...
    def destroy_custom_dashboard(self, guid=None):
        """
        Destroys a VipDashboard instance in VIP.
    ...
    def add_dashboard_tile(self, 
        ...
        """
        Create a new VipDashboardTile instance in VIP and assign it to a dashboard.

        :param name: :class:`str` Desired name of the dashboard (may be displayed in VIP). 
        ...
        :param header_text: :class:`str` Text to be displayed in the header bar of the tile in VIP.
        :param body_text: :class:`str` Text to be displayed in the body of the tile in VIP (for `text` tile_type only).
        :param width: :class:`int` or `float` Desired tile width in pixels (may be clamped by VIP, [370,1110]).
        :param height: :class:`int` or `float` Desired tile height in pixels (may be clamped by VIP [290,870]).
        ...
        :param dataset_name: :class:`str` Name of the dataset in VIP that holds the data needed for the tile (optional - for `histogram` and `piechart` tile_type only)
    ...
    def add_histogram_dashboard_tile(self,
        ...
        :param width: :class:`int` or `float` Desired tile width in pixels (may be clamped by VIP, [370,1110]).
        :param height: :class:`int` or `float` Desired tile height in pixels (may be clamped by VIP [290,870]).
        :param dataset_name: :class:`str` Name of the dataset in VIP that holds the data needed for the tile (required for `histogram`, `piechart`, and `snapshot` tile_type only)
        :param column_name: :class:`str` Name of the column used to the tile (optional - for `histogram` and `piechart` tile_type only)
        :param column_bins: :class:`int` Number of bins to display for a numerical histogram or piechart (optional - for `histogram` and `piechart` tile_type only, default value is 8 for histogram, 4 for piechart)
        :param breakdown_column_name: :class:`str` Name of breakdown column used to divide histogram bins further into groups (optional - for `histogram` tile_type only)
        :param breakdown_index: :class:`int` Preferred breakdown category, by index. Default value of -1 will display an aggregate of all categories in the breakdown. (optional - for `histogram` tile_type only)
    ...
    def create_annotation_from_instance(self, annotation:vip_annotation.VipAnnotation):
        """
        Creates a VIP annotation from an instance of a VipAnnotation.
    ...
    def set_annotation_color(self, id:str, windowColor=None, textColor=None):
        ...
        :param id: :class:`str` Annotation id provided by VIP.
    ...
    def delete_annotation(self, id:str):
        ...
        :param id: :class:`str` ID for an annotation (provided) by VIP.
        :return: :class:`None`
        """
    ...
    def show_annotations(self):
        """
        Triggers the global toggle to show all Annotations in VIP.
    ...
    def hide_annotations(self):
        """
        Triggers the global toggle to hide all Annotations in VIP.
    ...
    def get_all_annotations(self, a_type=None):
        """
        Get all annotations of a specific type in the current VIP project.
    ...
    def delete_all_annotations(self):
        """
        Deletes all Annotations (globally) in VIP.
    ...
    def collapse_all_annotations(self):
        """
        Triggers the global toggle to collapse all expanded Annotations in VIP.
