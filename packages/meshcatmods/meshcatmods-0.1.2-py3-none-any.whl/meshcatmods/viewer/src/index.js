...
class Viewer {
    ...
    create_camera() {
        ...
        // camera.position.set(5,5,5); // corner
        camera.position.set(5,0,2); // face on
    }
    ...
    set_camera(obj) {
        ...
        // this.controls.maxAzimuthAngle=3*Math.PI/4;
        // this.controls.maxPolarAngle=Math.PI/4;
        // this.controls.minDistance=2;
        // this.controls.maxDistance=2;
        
        // face on
        this.controls.minAzimuthAngle=3*Math.PI/2;
        this.controls.minPolarAngle=Math.PI/180*75;
        this.controls.maxAzimuthAngle=3*Math.PI/2;
