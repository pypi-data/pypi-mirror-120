...
if __name__ == "__main__":
    ...
    w.save_h5_file("/tmp/wf.h5",subgroupname="wfr3",intensity=True,phase=False,overwrite=True,verbose=True)
    w2 = GenericWavefront2D.load_h5_file("/tmp/wf.h5",filepath="wfr3")
