...
##################### 3361c48074e87cca528a788ba77a616f ##############################
...
class utils:
    ...
    def initialize(self, python_path, distro_data_path, default_path):
        """returns true if initalization was performed; returns false if initialization was already done
        """
        return self._swigobj.initialize(_str_ec(python_path), _str_ec(distro_data_path), _str_ec(default_path))
