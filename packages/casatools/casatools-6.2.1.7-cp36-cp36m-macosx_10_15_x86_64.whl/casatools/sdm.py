...
##################### 12e3d33092bb6599af08757c0cba4214 ##############################
...
class sdm:
    ...
    def fromms(self, mspath='', datacolumn='DATA', archiveid='S0', rangeid='X1', subscanduration=float(24.0*3600.0), sbduration=float(2700.0), apcorrected=False, verbose=True, useversion='v3'):
