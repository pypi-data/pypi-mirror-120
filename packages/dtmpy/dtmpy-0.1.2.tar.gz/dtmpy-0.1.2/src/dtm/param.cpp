...
static  char const *begin_restart_header="/***BEGIN_RESTART***/\n";
static  char const *end_restart_header="/***END_RESTART***/\n";
static  int  NumberOfYesStrings = 3;
static  char const *YesString[] = {"YES", "TRUE", "1"};
...
int     same_string_upcase_first_arg(char const *s, char const *t);
...
void    ddinf_error (char const *ermsg);
...
/*******************************************************/
const char *param_getc(char const *var_name, char const *dflt){
    ddlink *lp;
    printf("getc\n");
    param_init_par();
    if ((lp = prefixed_lookup(var_name)) == NULL) return dflt;
...
/*******************************************************/
const char *param_gets(const char *var_name){
    ddlink *lp;
    param_init_par();
    if ((lp = prefixed_lookup(var_name)) == NULL) {
...
/*******************************************************/
void  ddinf_error (const char *ermsg) {
