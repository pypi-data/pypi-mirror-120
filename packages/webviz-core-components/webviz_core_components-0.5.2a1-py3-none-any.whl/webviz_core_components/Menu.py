...
- showLogo (boolean; default True):
    ...
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, initiallyPinned=Component.UNDEFINED, menuBarPosition=Component.UNDEFINED, menuDrawerPosition=Component.UNDEFINED, showLogo=Component.UNDEFINED, navigationItems=Component.REQUIRED, **kwargs):
        self._prop_names = ['id', 'initiallyPinned', 'menuBarPosition', 'menuDrawerPosition', 'navigationItems', 'showLogo']
        self._type = 'Menu'
        self._namespace = 'webviz_core_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'initiallyPinned', 'menuBarPosition', 'menuDrawerPosition', 'navigationItems', 'showLogo']
