...
@LastEditTime: 2021-09-14 14:47:20
...
from seven_cloudapp_frame.handlers.w_client import *
from seven_cloudapp_frame.handlers.t_client import *
...
def seven_cloudapp_frame_route():
    return [
        ...
        (r"/", IndexHandler),
        #微信客户端
        (r"/w_cleint/voucher_order", w_pay.VoucherOrderHandler),  #创建微信预订单
        (r"/w_cleint/pay_notify", w_pay.PayNotifyHandler),  #微信支付异步同步
        (r"/w_cleint/refund_notify", w_pay.RefundNotifyHandler),  #微信退款异步同步
        #抖音客户端
        (r"/t_cleint/voucher_order", t_pay.VoucherOrderHandler),  #创建抖音预订单
        (r"/t_cleint/pay_notify", t_pay.PayNotifyHandler),  #抖音支付异步同步
        (r"/t_cleint/refund_notify", t_pay.RefundNotifyHandler),  #抖音退款异步同步
        #淘宝客户端
