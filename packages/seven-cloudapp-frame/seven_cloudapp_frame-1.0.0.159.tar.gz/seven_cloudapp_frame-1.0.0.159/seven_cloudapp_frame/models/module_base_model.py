...
@LastEditTime: 2021-09-07 14:49:20
...
class ModuleBaseModel():
    ...
    def get_act_module_list(self,app_id,act_id,module_name,start_date,end_date,is_del,page_size,page_index,is_cache=True):
        """
        ...
        if start_date != "":
            condition += " and start_date>=%s"
            params.append(start_date)
        if end_date != "":
            condition += " and end_date<=%s"
