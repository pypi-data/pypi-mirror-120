...
class Chart:
    ...
    def draw(self, lines: list, options: Optional[dict] = None) -> Any:
        ...
        :options: Configuration for graph title, axes, and more
          ...
          - :x_range: (List[float]) range of X values to graph
          - :y_range: (List[float]) range of Y values to graph
          - :x_label: (str) label on the X axis
          - :y_label: (str) label on the Y axis
          - :x_ticks: (float) tick interval for the X axis
          - :is_categorical: (bool) true to enable categorical mode
          - :smooth: (bool) true to enable smoothing
          - :grid: (str) grid type to use
          - :is_time_series: (bool) true to enable time series mode
          - :time_input_format: (str) input time format for time series data
          - :time_display_format: (str) output time format for time series data
...
class PhoneIoT:
    ...
    def add_button(self, device: str, x: float, y: float, width: float, height: float, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        ...
        :options: Additional options
          ...
          - :text_color: (int) The text color of the button.
          - :landscape: (bool) If set to true, rotates the button 90 degrees around its top left corner.
          - :font_size: (float) The size of the font to use for text (default 1.0).
    ...
    def add_label(self, device: str, x: float, y: float, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        ...
        :options: Additional options
          - :id: (str) The id to use for the control. If not specified, a new one will be automatically generated.
          - :text_color: (int) The text color of the label.
    ...
    def add_radio_button(self, device: str, x: float, y: float, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        ...
        :options: Additional options
          ...
          - :text_color: (int) The text color of the radio button.
          - :font_size: (float) The size of the font to use for text (default 1.0). Note that this will also scale up the size of the radio button itself (not just the text).
    ...
    def add_text_field(self, device: str, x: float, y: float, width: float, height: float, options: Optional[dict] = None) -> str:
        ...
        :options: Additional options
          ...
          - :text_color: (int) The text color of the text field.
    ...
    def add_toggle(self, device: str, x: float, y: float, text: Optional[str] = None, options: Optional[dict] = None) -> str:
        ...
        :options: Additional options
          ...
          - :text_color: (int) The text color of the toggle.
          - :font_size: (float) The size of the font to use for text (default 1.0). Note that this will also scale up the size of the toggle itself (not just the text).
    ...
    def listen_to_sensors(self, device: str, sensors: Optional[dict] = None):
        ...
        :sensors: structured data representing the minimum time in milliseconds between updates for each sensor type to listen for
          ...
          - :magnetic_field: (float) magneticField period
          - :rotation: (float) rotation period
          - :linear_acceleration: (float) linearAcceleration period
          - :game_rotation: (float) gameRotation sensor period
          - :light_level: (float) lightLevel period
          - :microphone_level: (float) microphoneLevel period
          - :proximity: (float) proximity period
          - :step_count: (float) stepCount period
