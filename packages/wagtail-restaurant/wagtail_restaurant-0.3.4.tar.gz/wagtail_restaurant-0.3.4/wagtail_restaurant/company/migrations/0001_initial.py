    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_photos', wagtail.core.fields.StreamField([('company_photos', wagtail.core.blocks.StructBlock([('company_photos', wagtail.core.blocks.ListBlock(wagtail.core.blocks.StructBlock([('company_photos', wagtail.images.blocks.ImageChooserBlock(required=False))])))]))], blank=True, null=True)),
