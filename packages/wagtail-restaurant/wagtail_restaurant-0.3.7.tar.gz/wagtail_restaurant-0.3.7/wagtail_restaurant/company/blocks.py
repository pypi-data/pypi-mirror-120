...
class CompanySettings(blocks.StructBlock):
    ...
    company_jpg_square = ImageChooserBlock(required=False)
...
class CompanyAddress(blocks.StructBlock):
    country = blocks.CharBlock(required=False, help_text="Country (eg.Deutschland)")
...
class CompanyPromote(blocks.StructBlock):
    slug = blocks.CharBlock(required=False, help_text="Slug")
...
class CompanyPhotos(blocks.StructBlock):
    ...
    company_photos = blocks.ListBlock(
                        blocks.StructBlock(
                            [
