    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_promote', wagtail.core.fields.StreamField([('company_promote', wagtail.core.blocks.StructBlock([('slug', wagtail.core.blocks.CharBlock(help_text='Slug', required=False)), ('promote', wagtail.core.blocks.RawHTMLBlock(help_text='Promote Text', required=False))]))], blank=True, null=True)),
                ('company_photos', wagtail.core.fields.StreamField([('company_photos', wagtail.core.blocks.StructBlock([('company_photos', wagtail.core.blocks.ListBlock(wagtail.core.blocks.StructBlock([('image', wagtail.images.blocks.ImageChooserBlock(required=False))])))]))], blank=True, null=True)),
