...
from .blocks import PageHeroBlock, HomeMenuHead, MenuDefaultBlock, MenuFlatBlock, MenuColumnBlock
...
class MenuPage(Page):
    ...
    menu_default = StreamField([("menu_default", MenuDefaultBlock())], null=True, blank=True)
