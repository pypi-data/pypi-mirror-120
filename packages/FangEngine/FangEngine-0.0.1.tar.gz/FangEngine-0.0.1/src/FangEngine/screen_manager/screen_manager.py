...
class ScreenManager:
    def __init__(
            ...
            show_cursor: bool = True, caption: str = "PyGE Application", framerate_cap: int = 60,
            icon_path: str = None
    ):
    ...
    def show_graphics_options(
            self, game_title: str = "Python Game Engine Demo", icon_path: str = None
    ) -> 'ScreenManager':
        opt = graphics_options.get_options(game_title, icon_path)
