...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'sah', 'mzn', 'eml', 'ace', 'ps', 'gor', 'ha', 'sa', 'crh', 'bcl',
        'wa', 'zh-classical', 'lij', 'mrj', 'mhr', 'hif', 'zu', 'shn', 'hak',
        'ban', 'as', 'roa-tara', 'hyw', 'pam', 'nso', 'ie', 'km', 'rue', 'se',
        'bh', 'vls', 'sn', 'nds-nl', 'mi', 'sc', 'nah', 'vep', 'myv', 'sat',
        'so', 'gan', 'glk', 'kab', 'tk', 'co', 'bo', 'fiu-vro', 'ab', 'kv',
        ...
        'pag', 'pi', 'av', 'awa', 'tay', 'haw', 'ig', 'rw', 'pap', 'xal',
        'krc', 'szy', 'za', 'pdc', 'kaa', 'inh', 'arc', 'to', 'kbp', 'jam',
        'wo', 'na', 'tpi', 'kbd', 'atj', 'nov', 'tcy', 'ki', 'tet', 'mdf',
        'ak', 'lld', 'lg', 'bi', 'jbo', 'roa-rup', 'lbe', 'kg', 'ty', 'xh',
        'fj', 'srn', 'om', 'trv', 'gcr', 'shi', 'sm', 'ltg', 'nqo', 'nia',
        'chr', 'tw', 'mnw', 'alt', 'pih', 'got', 'st', 'kl', 'mad', 'ks', 'cu',
        'ny', 'tn', 'bm', 'ts', 'rmy', 've', 'chy', 'rn', 'dag', 'tum', 'iu',
