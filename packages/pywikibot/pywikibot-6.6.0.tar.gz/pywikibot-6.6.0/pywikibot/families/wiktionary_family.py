...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'my', 'uz', 'li', 'or', 'te', 'eo', 'fa', 'ar', 'gl', 'jv', 'oc', 'ky',
        'az', 'eu', 'uk', 'br', 'ast', 'da', 'lo', 'skr', 'simple', 'bn', 'is',
        'hr', 'la', 'fj', 'tg', 'sk', 'bg', 'wa', 'ur', 'ps', 'cy', 'vo', 'sl',
        ...
        'mr', 'ks', 'su', 'ia', 'ang', 'fo', 'tt', 'mt', 'sd', 'gn', 'ie',
        'so', 'csb', 'ug', 'bcl', 'st', 'si', 'roa-rup', 'hif', 'zu', 'kl',
        'mi', 'ay', 'jbo', 'ln', 'yi', 'gu', 'na', 'gv', 'kw', 'tpi', 'ne',
        'rw', 'ts', 'ha', 'qu', 'ss', 'chr', 'iu', 'am', 'dv', 'sg', 'ti',
        'tn',
    ]
