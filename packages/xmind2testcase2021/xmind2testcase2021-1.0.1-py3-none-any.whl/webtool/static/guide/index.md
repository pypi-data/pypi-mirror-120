...
```
xmind2testcase2021 XMind测试用例模板.xmind -csv  ==> XMind测试用例模板.csv
```
...
```
# 默认使用5001端口好
xmind2testcase2021 webtool        => launch the web testcase convertion tool locally -> 127.0.0.1:5001

# 支持自定义端口号
xmind2testcase2021 webtool 8000   => launch the web testcase convertion tool locally -> 127.0.0.1:8000
```
