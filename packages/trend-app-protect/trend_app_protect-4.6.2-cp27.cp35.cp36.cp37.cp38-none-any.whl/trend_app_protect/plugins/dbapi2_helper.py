...
class ConnectionWrapper(object):
    ...
    # Lookup of special methods bypasses __getattr__ and __getattribute__.
    # They have to be explicitly re-implemented to emulate the wrapped object.
    ...
    def __exit__(self, type, value, traceback):
        return self._conn.__exit__(type, value, traceback)
