...
class SarmatCreator:
    ...
    def _get_behavior_classes(self, tag: str) -> List[Any]:
        ...
        for item in sub_tags:
            roles += self.role_tags.get(tag) or []
    ...
    def create_direction(self, tag: str, **kwargs):
        ...
        Direction = type('Direction', tuple(parents), dict())
    ...
    def create_destination_point(self, tag: str, **kwargs):
        ...
        classes = self._get_behavior_classes(tag)
        parents = chain([BhDestinationPoint], classes, [DestinationPointStructure])

        DestinationPointObject = type('DestinationPointObject', tuple(parents), dict())
    ...
    def create_geo_object(self, tag: str, **kwargs):
        ...
        classes = self._get_behavior_classes(tag)
        parents = chain([BhGeo], classes, [GeoStructure])

        GeoObject = type('GeoObject', tuple(parents), dict())
    ...
    def create_road_name(self, tag: str, **kwargs):
        ...
        RoadName = type('RoadName', tuple(parents), dict())
    ...
    def create_route_item(self, tag: str, **kwargs):
        ...
        RouteItem = type('RouteItem', tuple(parents), dict())
    ...
    def create_route(self, tag: str, **kwargs):
        ...
        classes = self._get_behavior_classes(tag)
        parents = chain([BhRoute], classes, [RouteStructure])

        Route = type('Route', tuple(parents), dict())
    ...
    def create_station(self, tag: str, **kwargs):
        ...
        classes = self._get_behavior_classes(tag)
        parents = chain([BhStation], classes, [StationStructure])

        Station = type('Station', tuple(parents), dict())
    ...
    def create_journey(self, tag: str, **kwargs):
        ...
        classes = self._get_behavior_classes(tag)
        parents = chain([BhJourney], classes, [JourneyStructure])

        Journey = type('journey', tuple(parents), dict())
    ...
    def create_road(self, tag: str, **kwargs):
        ...
        Road = type('Road', tuple(parents), dict())
    ...
    def create_journey_bunch_item(self, tag: str, **kwargs):
        ...
        JourneyBunchItem = type('JourneyBunchItem', tuple(parents), dict())
    ...
    def create_journey_bunch(self, tag: str, **kwargs):
        ...
        classes = self._get_behavior_classes(tag)
        parents = chain([BhJourneyBunch], classes, [JourneyBunchStructure])

        JourneyBunch = type('JourneyBunch', tuple(parents), dict())

        if kwargs.get('id') is None:
            kwargs['id'] = 0
        if kwargs.get('races'):
            kwargs['races'] = [self.create_journey_bunch_item(tag, **i) for i in kwargs['races']]
    ...
    def create_period_item(self, tag: str, **kwargs):
        ...
        PeriodItem = type('PeriodItem', tuple(parents), dict())
    ...
    def create_period(self, tag: str, **kwargs):
        ...
        Period = type('Period', tuple(parents), dict())
    ...
    def create_crew(self, tag: str, **kwargs):
        ...
        Crew = type('Crew', tuple(parents), dict())
    ...
    def create_permit(self, tag: str, **kwargs):
        ...
        Permit = type('Permit', tuple(parents), dict())
    ...
    def create_vehicle(self, tag: str, **kwargs):
        ...
        Vehicle = type('Vehicle', tuple(parents), dict())
