...
def main():
    ...
    parse.add_argument('-a', '--anime', help='get info of anime', nargs='+')
    parse.add_argument('-m', '--manga', help='get manga info', nargs='+')
    parse.add_argument('-ly', '--lyrics', help='get lyrics of the anime song', nargs='+')
    ...
    parse.add_argument('-v', '--version', action='version', version='1.4.9')
    ...
    if args.anime:
        ...
        'Sequel', sequel], ['Score', score], ['RANK', rank], ['Genre', genre],['Adaptation', adaptation]]
        if args.tablefmt:
            Console.print(tabulate.tabulate(table, headers='firstrow', tablefmt=args.tablefmt))
        else:
            Console.print(tabulate.tabulate(table, headers='firstrow'))
    if args.manga:
        ' '.join(args.manga)
