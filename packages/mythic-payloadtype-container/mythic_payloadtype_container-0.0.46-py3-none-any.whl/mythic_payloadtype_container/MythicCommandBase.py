...
class CommandBase(metaclass=ABCMeta):
    ...
    @property
    def filter_by_build_parameter(self):
        pass
    ...
    def to_json(self):
        ...
        return {
            ...
            "builtin": self.builtin if self.builtin is not None else False,
            "load_only": self.load_only if self.load_only is not None else False,
            "suggested_command": self.suggested_command if self.suggested_command is not None else False,
            "filter_by_build_parameter": self.filter_by_build_parameter if self.filter_by_build_parameter is not None else {},
            **bscript,
        }
