...
async def sync_classes(reference_id: str = ""):
    try:
        ...
        print_flush("[*] Agent function import complted. Now to parse the Payload and Command information")
        for cls in PayloadBuilder.PayloadType.__subclasses__():
...
async def connect_to_rabbitmq():
    ...
    if not os.path.exists(container_files_path):
        ...
        print_flush(f"[-] If this isn't in a Mythic service container, then this should be the path to your PayloadType folder", override=True)
