...
class Client:
    ...
    def __init__(self, api_token=None, host=None, proto=None):
    ...
    def _api_call(self, method, use_post=False, **kwargs):
        ...
        if use_post:
            r = requests.post(endpoint_url, headers=self.request_headers, json=kwargs)
        else:
            r = requests.get(endpoint_url, headers=self.request_headers, params=kwargs)
