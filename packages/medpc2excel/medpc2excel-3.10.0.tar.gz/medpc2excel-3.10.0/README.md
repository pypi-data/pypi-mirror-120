...
Use the package manager [pip](https://pip.pypa.io/en/stable/) to install medpc2excel. Current version is 3.10.0. 
It now allows to read both "*.txt" and non-extension files.
Fix the bug that read unexisting array from data file.
Remove mplcursor. The installation is no longer depended on mplcursor.
