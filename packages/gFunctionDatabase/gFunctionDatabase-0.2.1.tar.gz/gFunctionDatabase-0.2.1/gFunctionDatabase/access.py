...
A module that provides access to .json library files located in `Data/`
"""
...
class LibraryAccess:
    ...
    def load_library(self):
        ...
        if self.lib_style == 'zoned':
            additional_path = 'Data/zoned_rectangle_5m.json'
        elif self.lib_style == 'rectangle':
            additional_path = 'Data/rectangle_5m.json'
        elif self.lib_style == 'U':
            additional_path = 'Data/U_configurations_5m.json'
        elif self.lib_style == 'Open':
            additional_path = 'Data/Open_configurations_5m.json'
        else:
