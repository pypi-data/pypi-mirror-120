...
urlpatterns = [
    ...
    path('hubs/<uuid:hub_id>/hardwares', HubViewSet.listHubHardware),
    path('hubs/<uuid:hub_id>/channels', HubViewSet.listHubChannels),
    path('hubs/<uuid:hub_id>/accessories', HubViewSet.listHubAccessories),
