...
class AnyMessage(google.protobuf.message.Message):
    ...
    JSON_MESSAGE_FIELD_NUMBER: builtins.int
    ...
    @property
    def json_message(self) -> global___JSONMessage: ...

    def __init__(self,
        *,
        message : typing.Optional[global___Message] = ...,
        raw_message : typing.Optional[global___RawMessage] = ...,
        json_message : typing.Optional[global___JSONMessage] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"json_message",b"json_message",u"kind",b"kind",u"message",b"message",u"raw_message",b"raw_message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"json_message",b"json_message",u"kind",b"kind",u"message",b"message",u"raw_message",b"raw_message"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"kind",b"kind"]) -> typing_extensions.Literal["message","raw_message","json_message"]: ...
...
class JSONMessage(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    @property
    def body(self) -> global___JSONMessage.Body: ...

    def __init__(self,
        *,
        parent_event_id : typing.Optional[global___EventID] = ...,
        metadata : typing.Optional[global___MessageMetadata] = ...,
        body : typing.Optional[global___JSONMessage.Body] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"body",b"body",u"metadata",b"metadata",u"parent_event_id",b"parent_event_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"body",b"body",u"metadata",b"metadata",u"parent_event_id",b"parent_event_id"]) -> None: ...
global___JSONMessage = JSONMessage
