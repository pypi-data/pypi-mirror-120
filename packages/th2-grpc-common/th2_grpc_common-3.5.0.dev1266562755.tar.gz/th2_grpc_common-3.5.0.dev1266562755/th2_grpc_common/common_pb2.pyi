...
class MetadataFilter(google.protobuf.message.Message):
    ...
    class SimpleFilter(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal[u"king",b"king",u"simple_list",b"simple_list",u"value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"key",b"key",u"king",b"king",u"operation",b"operation",u"simple_list",b"simple_list",u"value",b"value"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"king",b"king"]) -> typing_extensions.Literal["value","simple_list"]: ...
