"""
Settings for Linets with urbano courier are all namespaced in the LINETS setting.
For example your project's `settings.py` file might look like this:

DJANGO_URBANO = {
    'URBANO': {
        'BASE_URL': '<URBANO_BASE_URL>',
        'TRACKING_BASE_URL': '<URBANO_TRACKING_BASE_URL>',
        'USER': '<URBANO_USER>',
...
class APISettings:
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'DJANGO_URBANO', {})
