...
ground_truth = dataset['code'].to_list()
...
#Call the function
def Kmeans_run(n_classes,iteration,random_state):
	label = kmeans(X,n_classes,iteration,random_state)
	print('Prediction = '+ str(dataset['code'].tolist()))
