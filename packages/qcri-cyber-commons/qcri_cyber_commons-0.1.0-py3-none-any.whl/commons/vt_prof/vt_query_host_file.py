...
def ext_features(infilename, outfilename, keywordfile):
    ...
    for domain in infile:
        ...
        outfile.write("{} {} {} {} {} {} {} {} {} {} {}\n".format(domain, record[0], total_count, mal_count, ratio, no_fqdns, keyword_count, float(keyword_count)/no_fqdns, float(dot_count)/no_fqdns, float(sentropy)/no_fqdns, record[4]))
    outfile.close()
...
if __name__ == "__main__":
    ...
    if method == "extract":
        ext_features(sys.argv[2], sys.argv[3], sys.argv[4])
    elif method == "subdoms":
