...
------------ | ------------- | ------------- | -------------
*BatchProcessingApi* | [**batch_process_request**](docs/BatchProcessingApi.md#batch_process_request) | **POST** /batch/process | Batch Process Request
*BatchProcessingApi* | [**check_batch_status_request**](docs/BatchProcessingApi.md#check_batch_status_request) | **POST** /batch/status | CheckBatchStatus
*BatchProcessingApi* | [**get_batch_report_request**](docs/BatchProcessingApi.md#get_batch_report_request) | **POST** /batch/retrieve | BatchReportRequest
...
*PaymentProcessingApi* | [**bin_range_lookup_request**](docs/PaymentProcessingApi.md#bin_range_lookup_request) | **POST** /bin | Bin Lookup
...
If the OpenAPI document is large, imports in citypay.api and citypay.model may fail with a
...
import citypay
from citypay.api import *
from citypay.model import *
```
