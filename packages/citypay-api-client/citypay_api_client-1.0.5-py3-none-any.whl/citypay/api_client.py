...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.batch_process_request  # this is an instance of the class Endpoint
        api_instance.batch_process_request()  # this invokes api_instance.batch_process_request.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.batch_process_request.callable or self.callable in this class
