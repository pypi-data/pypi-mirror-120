...
class BatchProcessingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.batch_process_request = _Endpoint(
            settings={
                'response_type': (ProcessBatchResponse,),
                'auth': [
                    'cp-api-key'
                ],
                'endpoint_path': '/batch/process',
            ...
            callable=__batch_process_request
        )

        def __check_batch_status_request(
            self,
            check_batch_status,
            **kwargs
        ):
        ...
        self.check_batch_status_request = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__check_batch_status_request
        )

        def __get_batch_report_request(
            self,
            ...
            **kwargs
            ...
            >>> thread = api.get_batch_report_request(batch_report_request, async_req=True)
            >>> result = thread.get()
        ...
        self.get_batch_report_request = _Endpoint(
            settings={
                'response_type': (BatchReportResponseModel,),
                'auth': [
                    'cp-api-key'
                ],
                'endpoint_path': '/batch/retrieve',
                'operation_id': 'get_batch_report_request',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_batch_report_request
        )
