...
class CConfigPresentation(IConfiguration):
    ...
    def _initialize_figure(self) -> figure:
        ...
        if self._options is None:
            return figure(figsize=(PRES.FIGUREWIDTH_NARROW, PRES.FIGUREWIDTH_NARROW))
        ...
        if l_extend == keys.FULL:
            return figure(figsize=(PRES.MAXWIDTH / l_fig_width_fraction, l_fig_height))
        elif l_extend == keys.NARROW:
            return figure(figsize=(PRES.FIGUREWIDTH_NARROW / l_fig_width_fraction, l_fig_height))
        elif l_extend == keys.BROAD:
            return figure(figsize=(PRES.FIGUREWIDTH_BROAD / l_fig_width_fraction, l_fig_height))
        else:
