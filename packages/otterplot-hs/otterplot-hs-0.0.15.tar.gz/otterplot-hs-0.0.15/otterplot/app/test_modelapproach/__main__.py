...
def main() -> None:
    ...
    #l_otterplotter = COtterPlotter(plotmode='presentation', extent='broad', figheight=4, grid=(6, 1),nonuniformax=[('0',':5'),('0','5')], axes3D=[0])
    l_otterplotter = COtterPlotter(plotmode='presentation',grid=(2,1),fraction=1)
    l_otterplotter.adjustlabels(xlabel='testlabel 1', ylabel='ylabel 2')
    # new devel
