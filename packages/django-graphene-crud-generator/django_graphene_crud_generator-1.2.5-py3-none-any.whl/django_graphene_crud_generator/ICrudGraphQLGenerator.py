...
class ICrudGraphQLGenerator(abc.ABC):
    ...
    def generate_graphql_crud_of(self,
        ...
        """
        build_context = BuildContext(django_type, django_graphql_type, django_input_type, kwargs)
    ...
    @abc.abstractmethod
    def _read_single_query_class_name(self, build_context: BuildContext) -> str:
        """
        :param build_context: information known at build time
    ...
    @abc.abstractmethod
    def _read_single_query_output_name(self, build_context: BuildContext) -> str:
        """
    ...
    def _generate_mutation_read_single(self, build_context: BuildContext) -> type:
        ...
        result, query_return_type = GraphQLHelper.generate_query_from_queryset_filter(
            ...
            queryset_filter=lambda queryset, query_type, info, args, kwargs: self._get_read_single_queryset_filter(queryset, RuntimeContext(build_context, info, query_type, args, kwargs)),
            arguments=arguments,
    ...
    @abc.abstractmethod
    def _read_all_query_class_name(self, build_context: BuildContext) -> str:
        """
    ...
    @abc.abstractmethod
    def _read_all_query_output_name(self, build_context: BuildContext) -> str:
        """
    ...
    @abc.abstractmethod
    def _check_if_object_exists(self, django_type: TDjangoModelType, runtime_context: RuntimeContext) -> Tuple[bool, Optional[models.Model]]:
        """
    ...
    @abc.abstractmethod
    def _create_generate_mutation_instance_row_already_exists(self, mutation_class: type, item_in_db: models.Model, runtime_context: RuntimeContext) -> any:
        """
