...
class FederationNamesMixIn:
    ...
    def subgraph_name(self, build_context: BuildContext) -> str:
    ...
    def _read_single_query_output_name(self, build_context: BuildContext) -> str:
        return f"{stringcase.camelcase(self.subgraph_name(build_context))}ReadAllResult"

    def _read_all_query_output_name(self, build_context: BuildContext) -> str:
        return f"{stringcase.camelcase(self.subgraph_name(build_context))}ReadSingleResult"
