...
Base Classes
------------
The ``maica_old.ml.base`` module includes basic classes of machine learning algorithms.
...
class Model:
    ...
    def __init__(self,
                 ...
                 alg_name: str):
        """
        :param alg_type: (*str*) A type of the algorithm defined in ``maica_old.core.env``.
        :param alg_name: (*str*) A name of the algorithm defined in ``maica_old.core.env``.
        """
