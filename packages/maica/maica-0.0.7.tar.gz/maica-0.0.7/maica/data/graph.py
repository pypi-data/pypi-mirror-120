...
class GraphDataset(Dataset):
    ...
    def __init__(self,
        ...
        """
        :param data: (*list*) A list of ``torch_geometric.data.Data`` objects representing the structured data.
        ...
        # An index of the graph structure in the data file.
    ...
    def split(self,
        ...
        :return: (*maica.data.graph.GraphDataset, maica.data.graph.GraphDataset*) Two sub-datasets and the original indices of the data in them.
        """
