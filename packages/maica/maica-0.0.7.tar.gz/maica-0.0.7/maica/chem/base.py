...
in converting unstructured chemical data into the formal data objects such as ``numpy.ndarray`` and ``torch.Tensor``.
"""
...
def load_mendeleev_feats():
    ...
    return preprocessing.scale(numpy.hstack([elem_feats, ion_energies]))
