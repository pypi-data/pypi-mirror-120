...
from ads.type_discovery.typed_feature import UnknownTypedFeature, CategoricalTypedFeature
...
class UnknownDetector(AbstractTypeDiscoveryDetector):
    ...
    def discover(self, name, series):
        ...
        if series.dtype == 'object':
            ...
            logger.debug("type discovery on column [{}]/[{}] result is Unknown".format(name, series.dtype))
