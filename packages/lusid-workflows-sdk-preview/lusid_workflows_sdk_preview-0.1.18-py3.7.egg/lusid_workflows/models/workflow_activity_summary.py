...
class WorkflowActivitySummary(object):
    ...
    def __init__(self, activity_name=None, activity_type=None, activity_execution_status=None, started_at=None, finished_at=None, execution_info=None, local_vars_configuration=None):  # noqa: E501
